...
<form action="{{ URL('offer/special_sku_product_edit_process') }}" method="post" name="editForm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                                    ...
                                    <div class="form-line" id="sku1">
                                        <select class="form-control show-tick" name="sku" required="">
                                            ...
                                            @foreach($sku as $skuname)
                                             <option value="{{ $skuname->id }}" @if ($productById->sku_id == $skuname->id) {{ "selected" }} @endif >{{ $skuname->name }}</option>
                                             @endforeach
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <label for="andProducts1">PRODUCTS NAME :</label>
                        <div class="form-group">

                            <div class="form-line" id="andProducts2">
                                <select class="form-control show-tick" name="andProducts">
                                    <option value="">Select Product</option>

                                    @foreach($andProduct as $andpname)
                                     <option value="{{ $andpname->id }}" @if ($productById->and_pid == $andpname->id) {{ "selected" }} @endif >{{ $andpname->name }}</option>
                                     @endforeach
                    ...
                    <div class="col-sm-12 col-md-2">
                        ...
                        <div class="form-group">
                            <div class="form-line" id="and_qty">
                                <input type="text" class="form-control" placeholder="Qty" name="and_qty" value="{{ $productById->and_qty }}" />
                            </div>
                        </div>
                    </div>
                </div>
