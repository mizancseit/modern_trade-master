            ...
            <div class="card">
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="returnNotApproveList()">Search</button>
                        </div>
                    </div>                                  
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultOrderList) > 0)   
                                    ...
                                    <tr>
                                       <th>
										<a href="{{ URL('/eshop-return-bucket/'.$orders->customer_id.'/'.$orders->party_id) }}" title="Show Details" target="_blank">
											{{ $orders->return_no }}
										</a></br>
