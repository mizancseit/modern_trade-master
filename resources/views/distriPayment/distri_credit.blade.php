    ...
    <div class="body">
          ...
          <br>
             <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <form action="{{ URL('/distri_payment_process') }}" method="post" id="distriPay">
                {{ csrf_field() }}    <!-- token -->
                    ...
                    <div class="modal-content">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <select id="bank_name" name="ssgbank_name" class="form-control show-tick">          <?php foreach( $ssg_bank as $bank){?>
                                                    <option value="<?php echo $bank->bank_name ?>"><?php  echo $bank->acctshortname."::".$bank->shortcode."::".$bank->bank_name;}?></option>
						...
						<!-- Maung Added Field-->
                                   <div id="ref_div" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Transaction Date" id="todate" name="trans_date" required="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Payment Remarks" id="todate" name="payment_remarks" />
                                        </div>
                                    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
			 ...
			 @if(sizeof($distriPayment) > 0)   
                    @php
                    $serial =1;
                    @endphp

                    @foreach($distriPayment as $RowDistriPayment) 
                        ...
                        @if($RowDistriPayment->ack_status=="NO")
                        
						<th><input type="button" name="point_edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editDistriPayment('{{ $RowDistriPayment->transaction_id }}')" style="width: 70px;"">
                        <input type="button" name="point_delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="deleteDistriPayment('{{ $RowDistriPayment->transaction_id}}')" style="width: 70px; margin-top: 0px;"></th>
