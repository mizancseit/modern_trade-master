            ...
            <div class="header">                
                <div class="row">
                    ...
                    <div class="col-sm-1"  style="text-align: left;">
                        <input type="number" class="form-control" id="" name="commission" maxlength="3" pattern="[1-9]" min="1" value="" style="width: 100px;"> 
                    </div>
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
                        ...
                        <tbody>
                            @if(sizeof($resultProduct) > 0)
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control" id="qty{{$serial}}" name="qty[]" maxlength="3" pattern="[1-9]" min="1" value="" style="width: 80px;" onkeyup="addQty({{$serial}})" onmouseout="totalsFO();">
                                    </td>
                                     <input type="hidden" class="form-control" id="value{{$serial}}" name="value[]" maxlength="3" value="0" style="width: 80px;" readonly=""> 
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <input type="hidden" class="form-control" id="totalValue" name="totalValue" readonly="" value="" style="width: 80px;">
