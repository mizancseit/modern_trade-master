...
class MasterUploadController extends Controller
{
  ...
  public function modern_target_list()
  {
        ...
        return view('eshop::sales/target/fo_target_upload' , compact('selectedMenu','selectedSubMenu','pageTitle','targetList','channelName','resultDivision','MonthList','executivelist'));
      }
      ...
      public function modern_target_search(Request $request)
      {
        ...
        return view('eshop::sales/target/targetList' , compact('targetList'));
      }
 ...
 public function modern_target_edit(Request $request)
 {
       ...
       // dd($targetList);
        return view('eshop::sales/target/fo_target_edit',compact('selectedMenu','selectedSubMenu','pageTitle','targetList','customerList','monthList')); 
