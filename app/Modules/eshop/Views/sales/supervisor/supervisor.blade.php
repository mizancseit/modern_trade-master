...
@section('content')
                ...
                <tbody> 
                    ...
                    <tr> 
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{ URL('supervisor_delete',$info->hierarchy_id) }}" class="btn btn-danger">Delete </a> </td>    
                    </tr>
                    @endforeach
                    @endif
                <tfoot> 
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <form action="{{ URL('supervisor_edit/') }}" method="post" id="editFrom">
            {{ csrf_field() }}    <!-- token -->
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #A62B7F">
    ...
    <script type="text/javascript">
        ...
        {  
            var action = '{{ URL('supervisor_edit/')}}/'+id;
            $("#editFrom").attr("action", action);
            $.ajax({
                method: "GET",
                url: '{{url('/get_supervisor')}}/'+id, 
            })
            .done(function (response)
            { 
                $('#editData').html('');    
