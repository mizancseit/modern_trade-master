    ...
    {{-- <li class="header">MAIN NAVIGATION</li> --}}
        ...
        @if(Auth::user()->module_type==3  && Auth::user()->user_type_id==5)
                   ...
                   <!--  <li @if($selectedMenu=='Advance Replace Report') class="active" @endif>
                    ...
                    <li @if($selectedMenu=='Outlet Ledger') class="active" @endif>
                        <a href="{{ URL('/eshop-outlet-ledger') }}">
                            <i class="material-icons">view_list</i>
                            <span>Outlet ledger</span>
                        </a>    
                    </li>
        ...
        @if(Auth::user()->module_type==3  && Auth::user()->user_type_id==6)
            ...
            <li @if($selectedMenu=='Category List') class="active" @endif>
                <a href="{{ URL('/eshop-categories-list') }}">
                    <i class="material-icons">view_list</i>
        ...
        <li>
            <a href="{{ URL('/eshop-partial-delivery-report') }}" >
                    <i class="material-icons">view_list</i>
                    <span>Partial delivery list</span>
                </a>
        </li>
        <li> <a href="javascript:void(0);" class="menu-toggle">
                    <i class="material-icons">view_list</i>
