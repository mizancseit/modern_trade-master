            ...
            <div class="card">
                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="allApprovedDelivery()">Search</button>
                        </div>
                    </div>
                    <div class="row">  
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultOrderList) > 0)   
                                    ...
                                    <tr>
                                        <th>{{ $serial }}</th>
                                        <th>
                                            <a href="{{ URL('/eshop-delivery-approved-view/'.$orders->order_id.'/'.$orders->fo_id) }}" title="Confirm Delivery" >
                                                {{ $orders->order_no }}
                                            </a>
                                        </th>
                                        ...
                                        <th style="text-align: right;"><a href="{{ URL('/eshop-approved-delivery2/'.$orders->order_id.'/'.$orders->customer_id.'/'.'yes') }}" class="btn bg-pink btn-block btn-lg waves-effect">Stock-In</a></th>  
