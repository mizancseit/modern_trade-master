    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                            ...
                            <table width="100%">
                                    ...
                                    <thead>
										...
										<tr>
										    ...
										    Req By &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : {{ $resultReqPro[0]->distributor_in_charge }} <br />
				...
				<form action="{{ URL('/dist/free-req-receive') }}" method="POST">		
							...
							<table class="table table-bordered">
                                  <thead>									
									...
									<input type="text" class="form-control" maxlength="4"  
										style="width: 80px;" id="qty{{$serial}}" name="received_qnty_<?=$items->req_det_id?>" value="{{ $items->delevered_qnty }}" 
									onkeyup="addRecQty({{$serial}})" readonly />
												...
												<th style="text-align: right;">
													...
													<input type="text" class="form-control" class="form-control" maxlength="4" 
														style="width: 80px;" id="value{{$serial}}" name="received_value_<?=$items->req_det_id?>" 
														value="{{ $items->delevered_value }}" readonly />
