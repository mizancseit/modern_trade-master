...
@section('content')
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">                        
                        <div class="info-box-2 bg-red">
                            ...
                            <a href="{{ URL('/return-only-bucket/'.$pointID.'/'.$routeid.'/'.$retailderid) }}" style="text-decoration: none;" title="Click To Bucket Details">
                                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="categories" class="form-control show-tick" onchange="returnOnlyProducts()" data-live-search="true">
            ...
            <form action="{{ URL('/return-only-add-to-cart') }}" method="POST">
                {{ csrf_field() }}    <!-- token -->
