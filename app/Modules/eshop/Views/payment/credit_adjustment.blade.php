    ...
    <div class="container-fluid">
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12">
                    <h2>
                       Customers Credit Adjustment List  dgdfg
                       <small> 
        ...
        <div class="card">
            <div class="header">
                <div class="row">
                    <div class="col-lg-9">
                        <h2>
                            Customers Credit Adjustment
                        </h2>

                    </div>
                    <div class="col-lg-3">
                        <button type="button"  id="ref" class="btn btn-default waves-effect m-r-20 pull-right" data-toggle="modal" data-target="#defaultModal">Add Adjustment</button>
                    </div>
                </div>
            ...
            <div class="body">
               ...
               <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="executiveAdjustmentList()">Search</button>
                </div>
            </div>

            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <form action="{{ URL('/credit-adjustment-process') }}" method="post" id="distriPay" enctype="multipart/form-data">
                    {{ csrf_field() }}    <!-- token -->
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #A62B7F">
                                <h4 class="modal-title"  style="color:white;" id="defaultModalLabel">Add Adjustment</h4>
                            </div>
                                    ...
                                    <div id="online_div" style="display: none">    
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                $ssg_bank=DB::select("select * from tbl_master_bank where status=0  order by id asc");
                            ...
                            <!-- Maung Added Field-->           
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Adjust Amount" name="adjust_amount" />
                                        </div>
                                    </div>
