            ...
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        ...
                        <small> 
                           <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/fo/returnproduct') }}"> Return </a> / <a href="{!! URL::previous() !!}"> New Order </a> / Return & Change Bucket
                       </small>
                   </h2>
               </div>

               <div class="col-lg-3">
                <a href="{{ URL('/fo/return-process/'.$retailderid.'/'.$routeid) }}">
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">                        
            ...
            <div class="header">
                <h2>ALL RETURN & CHANGE BUCKET PRODUCT</h2>                            
            </div>
            <div class="body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        @php
                        $totalReturn +=$itemsPro->return_qty;
                        $totalReturn1 +=$itemsPro->change_qty;
                        @endphp
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">@if($itemsPro->return_qty=='') {{ 0 }} @else {{ $itemsPro->return_qty }} @endif</td>

                            <td>{{ $itemsPro->chng_catname }}</td>
							...
							<td>
                                <input type="button" name="edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editReturnProductsM('{{ $itemsPro->return_order_det_id }}')" style="width: 70px;">

                                <input type="button" name="delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="returnItemDeleteM('{{ $itemsPro->return_order_det_id }}')" style="width: 70px; margin-top: 0px;">
                        ...
                        <tr>
                            ...
                            <th>&nbsp;</th>
                            <th>&nbsp;</th>
                            <th style="text-align: right;"> {{ $totalReturn1 }}</th>
                            <th>&nbsp;</th>                            
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-sm-3">
                        <a href="{{ URL('/fo/confirm-return/'.$resultInvoice->return_order_id.'/'.$resultInvoice->return_order_no.'/'.$retailderid.'/'.$routeid.'/'.$pointid.'/'.$distributorID) }}">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect">Confirm Return Request</button>
                        </a>
                    </div>
                    <div class="col-sm-2">
                            <button type="button" class="btn bg-red btn-block btn-lg waves-effect" data-toggle="modal" data-target="#confirm-return-change-delete-distributor">Delete</button>
                    </div>
                </div>
