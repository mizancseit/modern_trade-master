...
<section class="content">
    <div class="container-fluid">
            ...
            @php 
            if(session('isDepot')==1) // for depot
            {
            @endphp           
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Today Requisition</div>
                            <div class="number"><?php  if(isset($distTodayReq[0]->totCount)) 
                            {echo $distTodayReq[0]->totCount;} else {echo 0;}  ?>   </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Today Sent</div>
                            <div class="number"><?php  if (isset($distTodaySend[0]->totCount)) 
                                {echo $distTodaySend[0]->totCount;} else {echo 0;} ?> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Today Acknoledge</div>
                            <div class="number"><?php if (isset($distTodayAck[0]->totCount)) 
                                
                            {echo $distTodayAck[0]->totCount;} else {echo 0;}  ?> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Today Approved</div>
                            <div class="number"><?php if (isset($distTodayApprvd[0]->totCount)) 
                                
                            {echo $distTodayApprvd[0]->totCount;} else {echo 0;}  ?> </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Today In-Transit</div>
                            <div class="number"><?php if (isset($distTodayDelvrd[0]->totCount)) 
                            {echo $distTodayDelvrd[0]->totCount;} else {echo 0;}    ?> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Today Received</div>
                            <div class="number"><?php if (isset($distTodayRcvd[0]->totCount)) 
                            {echo $distTodayRcvd[0]->totCount;} else {echo 0;}  ?> </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-red">
                        ...
                        <div class="content">
                            <div class="text">Today Canceled</div>
                            <div class="number count-to" data-from="0" data-to="{{$distTodayCancld[0]->totCount}}" data-speed="1000" data-fresh-interval="{{$distTodayCancld[0]->totCount}}"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Total Stock</div>
                            <div class="number"><?php if (isset($resStockSummaryDist[0]->totStock)) 
                                {echo $resStockSummaryDist[0]->totStock;} else {echo 0;}  ?> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-teal hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Total Stock Value</div>
                            <div class="number"><?php if (isset($resStockSummaryDist[0]->totStockVal)) 
                            {echo number_format($resStockSummaryDist[0]->totStockVal,0);} else {echo 0;}    ?> </div>
                        </div>
                    </div>
                </div>  
