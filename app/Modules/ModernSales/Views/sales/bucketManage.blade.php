    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
               ...
               <div class="col-lg-3">
                <a href="{{ URL('/mts-order-manage-process/'.$order_id.'/'.$partyid.'/'.$customer_id) }}">
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            'mts_order.order_no','mts_order.party_id','mts_order_details.order_qty','mts_order_details.p_unit_price','mts_order_details.order_total_value','mts_order_details.order_date','tbl_product.name as proname','tbl_product.sap_code')
                            ...
                            <tr>
                                <th colspan="4" style="text-align: center;">Discount</th>
                                <th></th>
