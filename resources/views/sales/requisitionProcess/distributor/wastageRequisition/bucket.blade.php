                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2>
                            WASTAGE REQUISITION
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/dist/req-manage') }}"> Requisition </a> / <a href="{!! URL::previous() !!}"> New Requisition </a> / Bucket
                            </small>
                        </h2>
                    </div>

                    <div class="col-lg-3">
                        {{-- <a href="{{ URL('/dist/was-req-list-product/'.$reqid) }}">
                    ...
                    <div class="card">                        
                        ...
                        <div class="body">
                            <table class="table table-bordered">
                                    <thead>
										<tr>
                                            <th colspan="3">Depot Name: &nbsp;{{ $resultReqPro[0]->distributor_in_charge }}</th>                  
                                    ...
                                    <tbody>
										...
										{{-- <tr>
                                            ...
                                            <tr>
                                                ...
                                                <input type="button" name="delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="deleteWastageReqProductsM('{{ $items->id }}','{{ $items->req_id }}')" style="width: 70px; margin-top: 0px;">
                                                </th> --}}                                           
                                            </tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>                                        
                                <tr>
                                    ...
                                    <h4>YOUR WASTAGE REQUISITION PRODUCT IS EMPTY.</h4> <p></p><p></p>
