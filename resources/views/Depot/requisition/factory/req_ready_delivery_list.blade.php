...
<section class="content">
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        REQUISITION DELIVERY MANAGE
                        <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Requisition Delivery 
                        </small>
                    </h2>
                </div>
                </div>
					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @if(sizeof($resultReqList) > 0)   
                            ...
                            @foreach($resultReqList as $ReqRow)
							 ...
							 @php					
								$reultUser  = DB::select("SELECT * from users WHERE id = '".$ReqRow->billed_by."'");
                             @endphp                  							
							...
							<th style="text-align: center;"> 
                                    <a href="{{ URL('/reqDeliveryItemList/'.$ReqRow->req_id) }}" title="Click To Deliver">
                                        Deliver
                                    </a>   
