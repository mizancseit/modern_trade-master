        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        <small> 
                            <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Advance Replace Delivery 
                        </small>
                    </h2>
                </div>
            </div>
                    ...
                    <div class="body">
                            ...
                            <table class="table table-bordered" style="margin-top:-10px;">
                                ...
                                <tbody class="print-page" >
                                    ...
                                    ->select('mts_replace_details.p_unit_price','mts_replace_details.deliverey_qty','mts_replace_details.replace_det_id','mts_replace_details.cat_id','mts_replace_details.replace_id','mts_replace_details.order_qty','mts_replace_details.order_total_value','mts_replace_details.product_id','mts_replace_details.p_unit_price','tbl_product_category.id AS catid','tbl_product_category.name AS catname','mts_replace.replace_id','mts_replace.fo_id','mts_replace.order_status','mts_replace.party_id','tbl_product.id','tbl_product.name AS proname','tbl_product.sap_code')
