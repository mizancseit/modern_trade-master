        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">                        
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ->select('mts_replace_details.replace_det_id','mts_replace_details.cat_id','mts_replace_details.replace_id','mts_replace_details.order_qty','mts_replace_details.order_total_value','mts_replace_details.deliverey_qty','mts_replace_details.delivery_value', 
                                'mts_replace_details.product_id','mts_replace_details.replace_product_id','mts_replace_details.order_qty','mts_replace_details.p_unit_price','tbl_product_category.id AS catid','tbl_product_category.name AS catname','mts_replace.replace_id','mts_replace.fo_id','mts_replace.order_status','mts_replace.party_id','tbl_product.id','tbl_product.name AS proname')
                            ...
                            $replace_product = DB::table('tbl_product')
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-sm-3">
                        <a href="{{ URL('/mts-replace-delivery-approved-submit/'.$resultInvoice->replace_id.'/'.$resultInvoice->party_id.'/'.'yes') }}">
                    ...
                    <div class="col-sm-3">
                        ...
                        {{-- <a href="{{ URL('/mts-replace-delivery-approved-submit/'.$resultInvoice->replace_id.'/'.$resultInvoice->party_id.'/'.'no') }}">
