                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th></th>
                                <th colspan="6">{{ $items->catname }} <span class="pull-right">Discount: 
                                    @if($resultComm) 
                                    {{$resultComm->commission}}, Value: {{$resultComm->order_commission_value}}
                                    @else 
                                    0
                                    @endif</span></th>
                            </tr>
                            ...
                            ->select('mts_order_details.order_det_id','mts_order_details.cat_id','mts_order_details.order_id','mts_order_details.order_qty','mts_order_details.order_total_value','mts_order_details.product_id','mts_order_details.order_qty','mts_order_details.p_unit_price','tbl_product_category.id AS catid','tbl_product_category.name AS catname','mts_order.order_id','mts_order.fo_id','mts_order.order_status','mts_order.party_id','tbl_product.id','tbl_product.name AS proname')
