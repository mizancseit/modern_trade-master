        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">                        
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $reultPro  = DB::table('mts_return_details')
                                    ->select('mts_return_details.p_unit_price','mts_return_details.deliverey_qty','mts_return_details.return_det_id','mts_return_details.cat_id','mts_return_details.return_id','mts_return_details.order_qty','mts_return_details.order_total_value','mts_return_details.product_id','mts_return_details.p_unit_price','tbl_product_category.id AS catid','tbl_product_category.name AS catname','mts_return.return_id','mts_return.fo_id','mts_return.order_status','mts_return.party_id','tbl_product.id','tbl_product.name AS proname','tbl_product.sap_code')
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-sm-3">
                        <a href="{{ URL('/mts-return-delivery-approved-submit/'.$resultInvoice->return_id.'/'.$resultInvoice->party_id.'/'.'yes') }}">
                    ...
                    <div class="col-sm-3">
                        ...
                        {{-- <a href="{{ URL('/mts-return-delivery-approved-submit/'.$resultInvoice->return_id.'/'.$resultInvoice->party_id.'/'.'no') }}">
