                ...
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <h2>
                            Customer List 
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Customer
                         </small>
                     </h2>
                    </div> 
                    <div class="col-lg-2">
            ...
            <div class="card">
                ...
                <div class="body">
                  <div class="modal fade" id="defaultModal1" tabindex="-1" role="dialog">
                    <form action="{{ URL('/eshop-customer-create') }}" method="POST">
                        {{ csrf_field() }}    <!-- token -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> 
                            ...
                            @if($row->status==0)
                            <a href="{{ URL('/eshop-customer-active/'.$row->customer_id) }}">
                                <button type="button" class="btn bg-red btn-block btn-sm waves-effect"  style="width: 70px;">In-Active</button>
                            </a>
                            @else
                            <a href="{{ URL('/eshop-customer-inactive/'.$row->customer_id) }}">
