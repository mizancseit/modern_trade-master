...
','Ship To Party','Ref PO No','Ref PO Date','req del date','Order Note','Debit/Credit Note','Order Reason','Currency','Material Code','Qty','Plant Code','Storage Loc','Batch','Item Category','ZASV','ZEXP','ZFRH','ZTHP','ZSCR','ZRMS','ZAST');
	...
	public function export_sale_order(Request $Request) 
	{
		...
		->select('eshop_order.order_id','eshop_order.order_no as order_no', 'eshop_order.auto_order_no', 'eshop_party_list.name as partyName','eshop_customer_list.sap_code as sap_code','eshop_customer_list.name AS customerName','eshop_product.companyid AS CompanyCode',
		'eshop_product.sap_code AS MaterialCode','eshop_product_category.name AS Category','eshop_product_category.g_code AS g_code', 'eshop_product.name AS Material Name',
