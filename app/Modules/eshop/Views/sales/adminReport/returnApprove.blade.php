            ...
            <div class="card">
                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="returnDeliveryApproved()">Search</button>
                        </div>
                    </div> 
                    <div class="row">  
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultReturnList) > 0)   
                                    ...
                                    @foreach($resultReturnList as $orders)
                                    @php
                                    ...
                                    <tr>
                                        <th>{{ $serial }}</th>
                                        <th>
                                            <a href="{{ URL('/eshop-return-delivery-approved-view/'.$orders->return_id.'/'.$orders->fo_id) }}" title="Confirm Delivery" target="_blank">
                                                {{ $orders->return_no }}
                                            </a>
                                        </th>
