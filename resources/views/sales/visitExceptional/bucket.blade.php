        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    ...
                    @if($resultCartPro[0]->order_det_type == 'Ordered')
                    
                     <div class="col-lg-3">
                        <a href="{{ URL('/order-process-exception/'.$retailderid.'/'.$routeid.'/'.Request::segment(6)) }}">
                    ...
                    if($partial_id == 'part_'.$resultInvoice->order_count) {
                    
                    ?>
                    
                    <div class="col-sm-3">
                         <a href="{{ URL('/close-order-exception/'.$resultInvoice->order_id.'/'.Request::segment(5).'/'.Request::segment(6)) }}"> 
                            ...
                            <div class="body">
                                <table class="table table-bordered">
                                        ...
                                        $reultPro  = DB::table('tbl_order_details')
                                                    ...
                                                    'tbl_product_category.name AS catname','tbl_order.order_id','tbl_order.fo_id','tbl_order.order_type','tbl_order.offer_type',
                                                ...
                                                @if($resultCartPro[0]->order_det_type == 'Ordered')
                                                    ...
                                                    <input type="button" name="edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editProductsExc('{{ $itemsPro->order_det_id }}','{{ $pointid }}','{{ $routeid }}','{{ $retailderid }}','{{ $items->catid }}','{{ $itemsPro->product_id }}')" style="width: 70px;">
                                        ...
                                        @if(Request::segment(5)!='part_1' && Request::segment(5)!='part_2' && Request::segment(5)!='part_3' && Request::segment(5)!='part_4')
                                            ...
                                            @if(sizeof($specialValueWise)>0)               
                                                ...
                                                <th colspan="4">{{ $commissionAmount.' ('.$svwRows->commission.'%'.') ' }} 
                                                    <a href="{{ URL('/order-process-valuewise/'.$retailderid.'/'.$routeid.'/'.$svwRows->order_id.'/'.$commissionAmount.'/'.$items->catid.'/'.$svwRows->offer_id.'/'.'1') }}">
                                                        <input type="button" name="edit" id="edit" value="ADD" class="btn bg-green btn-block btn-sm waves-effect" style="width: 70px;">
                                                    </a>
                                                </th>
                                        ...
                                        @endif
                                            ...
                                            @if(sizeof($commissionWiseItem)>0)
                                                ...
                                                <tr style="background:#EEEEEE;">
                                                    <th colspan="8"> Exclusive Value Wise Free Items </th>
                                                </tr>
                                                @php
                                                $cPrice =0;
                                                $cqty =0;
                                            ...
                                            <tr style="background-color: #EEEEEE">
                                                ...
                                                <th colspan="3"> @if($resultBundleOffersGift->productType==2) {{ $resultBundleOffersGift->giftName }} @else {{ $resultBundleOffersGift->name }} @endif </th>
                                                <th style="text-align: right;"> {{ $resultBundleOffersGift->free_qty }} </th>
                                                <th colspan="4"> </th>     
                                            </tr>
                                            @endif -->
                                        </tfoot>
                                ...
                                @if($resultCartPro[0]->order_det_type == 'Ordered')
                                        ...
                                        <div class="col-sm-3">
                                         <a href="{{ URL('/confirm-order-exception/'.$resultInvoice->order_id.'/'.$resultInvoice->order_no.'/'.$retailderid.'/'.$routeid.'/'.$pointid.'/'.$distributorID . '/'. $partial_id) }}"> 
                                            <button type="submit" class="btn bg-pink btn-block btn-lg waves-effect">Confirm Order Request</button>
                                        </a> 
                                        
                                        </div>
                                        
                                        <div class="col-sm-2">
                                            <a href="{{ URL('/delete-order-exception/'.$resultInvoice->order_id.'/'.$retailderid.'/'.$routeid . '/'. $partial_id) }}" class="btn bg-pink btn-block btn-lg waves-effect"> Delete
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" onclick="deleteProductsExc()">Yes</button>
                </div>
            </div>
        </div>
    </div>
