                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="route" class="form-control show-tick" onchange="returnRoute()" data-live-search="true">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        @if(sizeof($resultRetailer) > 0)   
                                            ...
                                            @php
                                            $resultRetailer = DB::table('tbl_visit_return')
                                            ...
                                            <tr>
                                             ...
                                             <th><a href="{{ URL('/return-process/'.$retailers->retailer_id.'/'.$routeID) }}"> Return Collect </a></th>
                                                <th>
                                                    @if($checkStatus==3)
                                                    Collected
                                    ...
                                    <!--    @if($checkRetailers!=$retailers->retailer_id)
                                                ...
                                                <th>
                                                @if($checkStatus!=3)
                                                    <a href="{{ URL('/return-process/'.$retailers->retailer_id.'/'.$routeID) }}"> Order </a>
                                                @endif
                                                </th>
