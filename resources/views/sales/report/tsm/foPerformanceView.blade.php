...
<section class="content">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>MONTHLY FO PERFORMANCE REPORT</h2>                            
                </div>
                ...
                <div class="body">                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="tsmMonthlyfoPerformanceList()">Search</button>
                        </div>
                        <div class="col-sm-2">                        
