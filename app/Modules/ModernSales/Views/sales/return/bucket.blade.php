            ...
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        BUCKET
                        <small> 
                           <a href="{{ URL('/dashboard') }}">Dashboard</a>/<a href="{{ URL('/mts-return') }}"> Return </a>/<a href="{!! URL::previous() !!}">Order</a>/Bucket
                       </small>
                   </h2>
               </div>

               <div class="col-lg-3">
                <a href="{{ URL('/mts-return-process/'.$partyid.'/'.$customer_id) }}">
...
@endif
<form action="{{ URL('/mts-confirm-return') }}" method="post">
      {{ csrf_field() }}  
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ->select('mts_return_details.return_det_id','mts_return_details.product_id','mts_return_details.cat_id','mts_return_details.return_id','tbl_product_category.id AS catid',
                            'tbl_product_category.name AS catname','mts_return.return_id','mts_return.fo_id','mts_return.order_status',
                            'mts_return.return_no','mts_return.party_id','mts_return_details.order_qty','mts_return_details.p_unit_price','mts_return_details.order_total_value','mts_return_details.return_date','tbl_product.name as proname','tbl_product.sap_code')
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ URL('/mts-return-items-delete/'.$itemsPro->return_id.'/'.$itemsPro->return_det_id)}}">
                    ...
                    <div class="row" style="text-align: center;">
                        ...
                        <div class="col-sm-2">
                            <a href="{{ URL('/mts-delete-return/'.$resultInvoice->return_id.'/'.$partyid.'/'.$customer_id) }}">
