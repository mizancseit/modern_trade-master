                            ...
                            <tr>
                             ...
                             @endphp
								...
								<th> 
                                    ...
                                    @endphp
    									<a href="{{ URL('/dist/was-req-order-analysis/'.$ReqRow->req_id) }}" target="_blank" title="Click To Analysis">
                                            Analysis
                                        </a> || 
    									
    									<a href="{{ URL('/dist/was-req-canceled/'.$ReqRow->req_id) }}" target="_blank" title="Click To Cancel">
                                            Cancel
                                        </a>
                                    @php
