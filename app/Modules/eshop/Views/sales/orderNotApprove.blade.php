            ...
            <div class="card">
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="notApproveList()">Search</button>
                        </div>
                    </div>                                  
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultOrderList) > 0)   
                                    ...
                                    <tr>
                                       <th>
										<a href="{{ URL('/eshop-bucket/'.$orders->customer_id.'/'.$orders->party_id) }}" title="Show Details" target="_blank">
											{{ $orders->order_no }}
										</a></br>
