    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="card">
                ...
                <br>
                <div class="body">
                    <form action="{{ URL('/dist/free-req-process') }}" method="post">
                        {{ csrf_field() }}    <!-- token -->
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        value="{{'F'.$reqAddList[0]->email . date('dmY') . $LastReqId[0]->last_req_id }}" readonly />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" placeholder="Requisition Date" value="{{ date('Y-m-d H:i:s') }}" name="req_date"
