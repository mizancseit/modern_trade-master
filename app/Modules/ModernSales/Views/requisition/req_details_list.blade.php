                            ...
                            <table class="table table-bordered">
                                    <thead>
										<tr>
                                            ...
                                            <th colspan="2">Status: &nbsp;{{ strtoupper($resultReqPro[0]->req_status) }}</th>                  
                                        </tr>
                                        <tr>
                                            <th>SL</th>
                                            <th>Product Group</th>
                                    ...
                                    <tbody>
										...
										<?php 
											...
											$totalReqQty += $items->req_qnty;
											$totalReqValue += $items->req_value;
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
											...
											<th style="text-align:right;">{{ $totalReqQty }}</th>
											<th style="text-align:right;">{{ $totalReqValue }}</th>
                                        </tr>
