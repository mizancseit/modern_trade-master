...
<section class="content">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>DB/DEPOT PERFORMANCE REPORT</h2>                            
                </div>
                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <select id="divisions" name="divisions" class="form-control show-tick" data-live-search="true" onchange="foPerformanceTerritory()">
                        ...
                        <div class="col-sm-2" id="territory">
                            <select name="territory" id="territory" class="form-control show-tick" data-live-search="true" onchange="dbPerformancePoints()">
                                <option value=""> Select Territory</option>                
                            </select>
                        </div>

                        <div class="col-sm-2" id="fopoints">
                            <select name="pointsID" id="pointsID" class="form-control show-tick" data-live-search="true">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="dbPerformanceList()">Search</button>
                        </div>
                    </div>                                  
                </div>
            </div>
