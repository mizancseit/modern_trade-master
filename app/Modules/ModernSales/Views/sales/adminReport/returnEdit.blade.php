        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">                        
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-sm-3">
                        <a href="{{ URL('/mts-approved-return/'.$resultInvoice->return_id.'/'.$resultInvoice->party_id.'/'.'yes') }}">
                    ...
                    <div class="col-sm-3">
                        ...
                        {{-- <a href="{{ URL('/mts-approved-return/'.$resultInvoice->return_id.'/'.$resultInvoice->party_id.'/'.'no') }}">
