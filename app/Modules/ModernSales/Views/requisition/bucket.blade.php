                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2>
                            Requisition
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/visit') }}"> Req List </a> / <a href="{!! URL::previous() !!}"> New Requisition </a> / Requisition
                            </small>
                        </h2>
                    </div>

                    <div class="col-lg-3">
                        <a href="{{ URL('/req-list_product/'.$reqid) }}">
                        ...
                        <div class="body">
                            <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $totalValue = 0;
                                        @endphp
                                        @foreach($resultReqPro as $items)    @php
										...
										<tr>
                                            ...
                                            <tr>
                                                ...
                                                <input type="button" name="edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editDepotProducts('{{ $items->id }}')" style="width: 70px;">

                                                
                                                <input type="button" name="delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="deleteDepotProducts('{{ $items->id }}')" style="width: 70px; margin-top: 0px;">
