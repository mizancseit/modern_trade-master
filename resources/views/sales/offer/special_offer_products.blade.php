                ...
                <div class="card">
                    ...
                    <div class="body">
                      ...
                      <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                        <form action="{{ URL('offer/special_offer_product_save') }}" method="post">
                            {{ csrf_field() }}    <!-- token -->
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
            ...
            <tbody>
                @if(sizeof($resultSpecialproducts) > 0)   
                @php
                $i =1;
                @endphp

                @foreach($resultSpecialproducts as $regularProduct) 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="button" name="product_edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editSpecialProduct('{{ $regularProduct->id }}','{{ $regularProduct->offerProId }}','{{ $regularProduct->and_pro_cat_id }}')" style="width: 70px;">
                        <input type="button" name="point_delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="deleteSpecialProduct('{{ $regularProduct->id}}')" style="width: 70px; margin-top: 0px;">
                    </td>
                </tr>
