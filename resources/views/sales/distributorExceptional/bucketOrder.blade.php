                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                @if(sizeof($resultPartialOrder)>0)
                                    ...
                                    {
                                        $url = URL('/order-edit-exceptional/'.$partialOrder->order_id.'/'.$foMainId.'/'.$partialOrder->partial_order_id);
                                    }
                                    else if($partialOrder->order_det_type=='Delivered')
                                    {
                                        $url = URL('/invoice-partial-exceptional/'.$partialOrder->order_id.'/'.$foMainId.'/'.$partialOrder->partial_order_id);
                                    }
