                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="row">  
                            ...
                            <div class="col-sm-4" id="outletDiv">
                                <select id="customer_id" class="form-control show-tick" data-live-search="true" required="">
                                    <option value="">-- Select Outlet--</option>                                               
                                </select>
                            </div>
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="outlet_ledger_list()">Search</button>
                        </div>
                        <div class="col-sm-4">
