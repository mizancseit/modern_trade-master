...
<form action="{{ URL('/mts-edit-submit') }}" method="post">
    {{ csrf_field() }}    <!-- token -->
            ...
            <div class="modal-body"> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                     ...
                     <div class="col-sm-3">
                        <input type="number" oninput="validateInput(this)" step="0.01" min="1" name="commission" id="commission" class="form-control" placeholder="Discount %" value="@if(sizeof($checkCommission)>0){{$checkCommission->commission}}@endif" maxlength="8">
                    </div>
