                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
                        ...
                        <tbody>
                            @if(sizeof($resultProduct) > 0)
                                ...
                                <tr>
                                    ...
                                    <th style="display: none;"><input type="number" class="form-control" id="wastageQty{{$serial}}" name="wastageQty[]" maxlength="3" style="width: 80px;" onkeyup="totalsWastagesFO();addWastage({{$serial}})"></th>                                            
                                </tr>
                                @php
                                $serial ++;
                                @endphp
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th style="display: none;"><input type="text" class="form-control" id="totalWastage" name="totalWastage" readonly="" value="0" style="width: 80px;"></th>                               
                            </tr>
                        </tfoot>
                    </table>
