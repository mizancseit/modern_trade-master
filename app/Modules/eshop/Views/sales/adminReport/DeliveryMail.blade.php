                        ...
                        <div class="row">
                           {{--  <div class="col-lg-3">
                            ...
                            <div class="body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="6">{{ $items->catname }} @if(sizeof($resultComm)>0)<span class="pull-right">Discount: {{$resultComm->commission}}, Value: {{$resultComm->order_commission_value}}</span>
                                                @endif
                                                </td>
                                        </tr>
                                    ...
                                    <tr>
                                        <th colspan="3" style="text-align: right;">Commission</th>
                                        <th>&nbsp;</th>
                            ...
                            <div class="row" style="text-align: center;">
                                ...
                                <div class="col-sm-3 " >
                                    <a href="{{ URL('/eshop-email-approval/'.$resultInvoice->order_id.'/'.$resultInvoice->party_id) }}">
                                        <button type="button" class="btn bg-warning btn-block btn-lg waves-effect">Send mail for approval</button>
                                    </a>
                                </div>
                                @else
                                <div class="col-sm-3">
                                    <a href="{{ URL('/eshop-approved-order/'.$resultInvoice->order_id.'/'.$resultInvoice->party_id.'/'.'yes') }}">
