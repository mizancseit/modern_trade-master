                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h2>
                            ...
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Return & Change
                            </small>
                        </h2>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="route" class="form-control show-tick" onchange="returnRouteM()" data-live-search="true">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        @if(sizeof($resultRetailer) > 0)   
                                            ...
                                            @php
                                            $resultRetailer = DB::table('tbl_visit_return_distributor')
                                            ...
                                            <tr>
                                                ...
                                                <th><a href="{{ URL('/fo/return-process/'.$retailers->retailer_id.'/'.$routeID) }}"> Return Collect </a></th>
                                                <th></th>
                                                @else
                                                <th>
                                                @if($checkStatus!=3)
                                                    <a href="{{ URL('/fo/return-process/'.$retailers->retailer_id.'/'.$routeID) }}"> Order </a>
                                                @endif
                                                </th>
