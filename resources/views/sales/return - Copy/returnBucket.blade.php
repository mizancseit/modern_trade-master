            ...
            <div class="body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        @php
                            $serial ++;
                            $totalReturnQty += $totalReturnQty + $itemsPro->return_qty;
                            $totalReturnValue += $totalReturnValue + $itemsPro->return_value;
                            $totalChangeQty += $totalChangeQty + $itemsPro->change_qty;
                            $totalChangeValue += $totalChangeValue + $itemsPro->change_value;
                        ...
                        <tr>
                            ...
                            <th>&nbsp;</th>
                             <th style="text-align: right;">{{$resultInvoice->total_change_qty}}</th>
                             <th style="text-align: right;">{{$resultInvoice->total_change_value}}</th>
                            <th>&nbsp;</th>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="row" style="text-align: center;">
                    ...
                    <div class="col-sm-3">
                        <a href="{{ URL('/confirm-return/'.$resultInvoice->return_order_id.'/'.$resultInvoice->return_order_no.'/'.$retailderid.'/'.$routeid.'/'.$pointid.'/'.$distributorID) }}">
