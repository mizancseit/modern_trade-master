...
@section('content')
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{ URL('/eshop-add-replace-products') }}" method="POST">
                {{ csrf_field() }}  
