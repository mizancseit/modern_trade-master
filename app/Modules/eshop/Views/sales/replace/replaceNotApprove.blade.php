        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-9">
                    <h2> 
                        <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Not approve order 
                        </small>
                    </h2>
                </div>
            </div>
            ...
            <div class="card">
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="replaceNotApproveList()">Search</button>
                        </div>
                    </div>                                  
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultOrderList) > 0)   
                                    ...
                                    <tr>
                                       <th>
										<a href="{{ URL('/eshop-replace-bucket/'.$orders->customer_id.'/'.$orders->party_id) }}" title="Show Details" target="_blank">
											{{ $orders->replace_no }}
										</a></br>
