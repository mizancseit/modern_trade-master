            ...
            <div class="card">
                ...
                <div class="body">
                  ...
                  <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                    <form action="{{ URL('offer/regular_sku_product_save') }}" method="post">
                        {{ csrf_field() }}    <!-- token -->
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" name="product_edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editRegularSku('{{ $regularProduct->id }}','{{ $regularProduct->offerProId }}','{{ $regularProduct->catid }}','{{ $regularProduct->and_pro_cat_id }}','{{ $regularProduct->and_pid }}')" style="width: 70px;">
                    <input type="button" name="point_delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="deleteRegularSku('{{ $regularProduct->id}}')" style="width: 70px; margin-top: 0px;">
                </td>
            </tr>
