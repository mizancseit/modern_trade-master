                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
										...
										<select class="form-control show-tick" name="route_id" required="" onchange="getRetailerList(this.value)">
											...
											<?php if($depotCollection[0]->route_id == $rowRoute->route_id) { ?>
										
											<option value="{{ $rowRoute->route_id }}" selected>{{ $rowRoute->rname }}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line" id="div_ratailer_edit">
