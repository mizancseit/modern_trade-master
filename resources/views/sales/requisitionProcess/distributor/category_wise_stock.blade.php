...
@section('content')
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <h2>
                            PHYSICAL INVENTORY
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/dist/inventory') }}"> Physical Inventory </a> 
                            </small>
                        </h2>
                    </div>
                    <div class="col-lg-2">
            ...
            <div class="card">
                ...
                <div class="body">
                  <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                    <form action="{{ URL('/dist/inventory_file_upload') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}    <!-- token -->
            ...
            <form action="{{ URL('/dist/add_to_inventory') }}" method="POST">
                {{ csrf_field() }}    <!-- token -->
