...
<section class="content">
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Report / Sales Order 
                        </small>
                    </h2>
                </div>
            </div>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>Sales Order Party & Item Wise </h2>                            
                </div>
                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <input type="hidden" name="executive_id" id="executive_id" value="">
                        <input type="hidden" name="fos" id="fos" value="">
                        ...
                        <div class="row">
							<div class="col-sm-2">
                                <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="managerDeliveryReportImsWise()">Search</button>
                            </div>
                            <div class="col-sm-2">                        
                               <img src="{{URL::asset('resources/sales/images/loading.gif')}}" id="loadingTimeMasud" style="display: none; text-align: center;">
                            </div>
                        </div>                                  
                </div>
            </div>
