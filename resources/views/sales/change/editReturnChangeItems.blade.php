...
<form action="{{ URL('/return-edit-submit') }}" method="post">
    {{ csrf_field() }}    <!-- token -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="items_return" id="items_return" class="form-control" value="{{ $resultPro->return_qty }}" maxlength="8">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="items_change" id="items_change" class="form-control" value="{{ $resultPro->change_qty }}" maxlength="8">
                    </div>
                </div>
