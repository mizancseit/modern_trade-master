							                	...
							                	@foreach($resultBundleSlab as $slabs)
									                <tr style="background:#BFBFBF" id="prof_{{ $slabSerial }}">
			                                            <th style="text-align: center;">
			                                            	<input type="number" id="from_slab1{{ $slabSerial }}" name="from_slab1[]" value="{{ $slabs->iMinRange }}" class="form-control" style="padding:5px 10px;background-color: #FFF; font-weight: normal;" disabled="">
			                                            </th>
			                                            <th style="text-align: center;">
			                                            	<input type="number" id="to_slab1{{ $slabSerial }}" name="to_slab1[]" value="{{ $slabs->iMaxRange }}" class="form-control" style="padding:5px 10px;background-color: #FFF; font-weight: normal;" disabled="">
			                                            </th>
