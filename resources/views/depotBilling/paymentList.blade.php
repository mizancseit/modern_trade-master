					...
					<div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" name="fromPaymentDate" id="fromdate1" class="form-control" value="<?= $sel_fromPaymentDat; ?>" autocomplete="off" placeholder="Payment From Date">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" name="toPaymentDate" id="todate1" class="form-control" value="<?= $sel_toPaymentDate; ?>" autocomplete="off" placeholder="Payment To Date">
                                </div>
                            </div>
                        </div>
                 ...
                 <div class="table-responsive">  
					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
					   ...
					   <th>{{$payment->branch_name}}</th> 
						...
						<th>
						    <input type="hidden" id="pay_amount{{$payment->transaction_id}}" name="pay_amount{{$payment->transaction_id}}" value="{{$payment->trans_amount}}" />
						    <input type="text" size="5" id="net_amount{{$payment->transaction_id}}" name="net_amount[{{$payment->transaction_id}}]" value="" onkeyup="getBankCharge({{$payment->transaction_id}})" />
						</th> 
						
						<th>
							<input type="text" size="5" id="bank_charge{{$payment->transaction_id}}" name="bank_charge[{{$payment->transaction_id}}]" value="" />
						</th> 
						<th > 
							
                                    
                                    <input name="amtack[{{$payment->transaction_id}}]" type="checkbox" id="radio_yes[{{$dynLabel}}]" class="radio-col-red" value="YES">
						...
						<th>
							<textarea name="ack_remarks[{{$payment->transaction_id}}]"></textarea>
						</th> 
