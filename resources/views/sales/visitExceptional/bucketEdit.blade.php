                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h2>
                            BUCKET EDIT
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/order-manage-exception') }}"> Order Manage </a> / Bucket Edit
                            </small>
                        </h2>
                    </div>
                    @if($resultCartPro[0]->order_status !='Closed')
                    <div class="col-lg-3">
                        <a href="{{ URL('/invoice-edit-exception/'.$resultInvoice->order_id.'/'.$retailderid.'/'.$routeid.'/'.$partial_id.'/'.Request::segment(7)) }}">
					...
					if($resultCartPro[0]->partial_order_id == 'part_'.$resultCartPro[0]->order_count && $resultCartPro[0]->order_status !='Closed') {
					
					?>
					
					<div class="col-sm-3">
						 <a href="{{ URL('/close-order-manage-exception/'.$resultInvoice->order_id.'/'.Request::segment(6).'/'.Request::segment(7)) }}"> 
                        ...
                        <div class="body">
                            <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <input type="button" name="edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editProductsExc('{{ $itemsPro->order_det_id }}','{{ $pointid }}','{{ $routeid }}','{{ $retailderid }}','{{ $items->catid }}')" style="width: 70px;">
                                                
                                                <input type="button" name="delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="itemDeleteExc('{{ $serial }}')" style="width: 70px; margin-top: 0px;">
                                            ...
                                            @php                                             
                                                    ...
                                                    ->select('fq.type','fq.auto_order_no','fq.catid','fq.status','fq.product_id','fq.total_free_qty','tbl_product.id','tbl_product.name AS proname','fq.free_id')
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>&nbsp; <input type="hidden" name="netAmount" id="netAmount" value="{{ $subTotal }}"> </th>
                                            <th>&nbsp;</th>                                            
                                            <th>&nbsp;</th>                                            
                                            <th>&nbsp;</th>                                            
                                            <th>&nbsp;</th>                                            
							...
							<?php if($resultCartPro[0]->order_status == 'Closed')  { ?>	
								...
								<div class="row">
                                    ...
                                    @if(Request::segment(7)=='Exclusive')
                                    {{-- For Special offer --}}
