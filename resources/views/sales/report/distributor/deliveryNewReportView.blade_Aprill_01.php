                ...
                <div class="body" id="printMe" >    
                    ...
                    <div class="body">
                        ...
                        <table width="100%">
                            <thead>
                                <tr>
                                    <th width="80%" align="left" valign="top">
                                        <span style="font-face:arial;font-size:8;font-weight: bold; text-transform: uppercase; color: #263F93;">
									...
									<?php if($resultDistributorInfo->business_type_id == 1 ) { ?>
                                        <span style="font-face:arial;font-size:8;font-weight: bold;"> Delivery Memo (Lighting) </span> 
                                    <?php } elseif($resultDistributorInfo->business_type_id == 2) { ?>
										<span style="font-face:arial;font-size:8;font-weight: bold;"> Delivery Memo (Accessories) </span>  
                                    <?php } ?>
									</th>
                                </tr>
                            </thead>
                        ...
                        <table class="table table-bordered" style="margin-top:-10px;">
                            <thead >
                                <tr>
                                    ...
                                    <th style="width:33%; font-face:arial;font-size:8;font-weight: normal; line-height: 1%;">Item</th>
                            ...
                            <tbody class="print-page" >
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <th style="font-face:arial;font-size:8;font-weight: normal; line-height: 1%;">{{ $serial }}</th>
