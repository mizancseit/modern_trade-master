...
Route::group(
    ['middleware' => ['web', 'auth'], 'module' => 'eshop', 'namespace' => 'App\Modules\eshop\Controllers'], function () {
		...
		Route::get('/eshop_summary_report_ajax', 'EshopDeliveryController@eshop_summary_report_ajax');///eshop-summary-report
		...
		/////// e_shop_customer  ////////
		Route::get('/e-shop-customer', 'EshopCustromerController@customer_list');
		Route::post('/e-shop-customer-create', 'EshopCustromerController@customer_create');
		Route::post('/e-shop-customer-edit', 'EshopCustromerController@customer_edit');


		Route::get('/e-shop-customer-active/{id}','EshopCustromerController@eshop_customer_active');
		Route::get('/e-shop-customer-inactive/{id}','EshopCustromerController@eshop_customer_inactive');
 
		Route::get('/e-shop-customer-delete/{id}','EshopCustromerController@customer_delete');
		//e-shop-customer-edit-process
		Route::post('/e-shop-customer-edit-process', 'EshopCustromerController@customer_edit_process');
		...
		Route::get('/eshop-addUser', 'EshopAdminController@addUser');
			...
			Route::get('/eshop-outlet-ledger', 'EshopAdminController@customer_ledger');
			Route::post('/eshop-outlet-ledger-list', 'EshopAdminController@customer_ledger_list'); 
