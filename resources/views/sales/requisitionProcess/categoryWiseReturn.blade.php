...
@section('content')
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">                        
                        <div class="info-box-2 bg-red">
                            ...
                            <a href="{{ URL('/fo/return-only-bucket/'.$pointID.'/'.$routeid.'/'.$retailderid) }}" style="text-decoration: none;" title="Click To Bucket Details">
                                <div class="content">
                                    <div class="text">RETURN VALUE</div>
                                    <div class="number count-to" data-from="0" data-to="@if(sizeof($resultCart)>0) {{ $resultCart->total_return_only_value }} @else 0 @endif" data-speed="1000" data-fresh-interval="20">@if(sizeof($resultCart)>0) {{ $resultCart->total_return_only_value }} @else 0 @endif</div>
						        </div>
					        </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="categories" class="form-control show-tick" onchange="returnOnlyProductsM()" data-live-search="true">
            ...
            <form action="{{ URL('/fo/return-only-add-to-cart') }}" method="POST">
                {{ csrf_field() }}    <!-- token -->
