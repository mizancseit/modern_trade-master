                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-3">                        
                            <div class="info-box-2 bg-red">
                                ...
                                <a href="{{ URL('/bucket/'.$pointID.'/'.$routeid.'/'.$retailderid . '/part_1') }}" style="text-decoration: none;" title="Click To Bucket Details">
                                    <div class="content">
                                        <div class="text">BUCKET</div>
                                        <div class="number count-to" data-from="0" data-to="@if(sizeof($Bucket_1)>0) {{ $Bucket_1[0]->grand_total_value }} @else 0 @endif" data-speed="1000" data-fresh-interval="20">@if(sizeof($Bucket_1)>0) {{ $Bucket_1[0]->grand_total_value }} @else 0 @endif</div>
                                    </div>
                                </a>
                            </div>
                        </div>
