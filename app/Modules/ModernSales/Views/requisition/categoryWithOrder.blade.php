...
@section('content')
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">                        
                        <div class="info-box-2 bg-red">
                            ...
                            <a href="{{ URL('/req-bucket/'.$req_id) }}" style="text-decoration: none;" title="Click To Bucket Details">
                                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="categories" class="form-control show-tick" onchange="allRequisitionProducts()" data-live-search="true">
            ...
            <form action="{{ URL('/req-add-to-product') }}" method="POST">
                {{ csrf_field() }}    <!-- token -->
