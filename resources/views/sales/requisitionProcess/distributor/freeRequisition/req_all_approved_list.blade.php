					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @if(sizeof($resultReqList) > 0)   
                            ...
                            <tr>
								...
								<th>
                                    <a href="{{ URL('/dist/free-req-open-order-list/'.$ReqRow->req_id) }}" title="Click To Details" target="_blank">
                                      {{ $ReqRow->display_name }}
                                    </a>
                                </th>
							...
							<th style="text-align: center;"> 
                                ...
                                @endphp
                                    <a href="{{ URL('/dist/free-req-deliver/'.$ReqRow->req_id) }}" title="Click To Deliver" onClick="return confirm('Are you sure to Delivered?')">
                                        Deliver
                                    </a>   
								@php
