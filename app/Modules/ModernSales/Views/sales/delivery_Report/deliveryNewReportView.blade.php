                       ...
                       {{--  <table width="100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="55%" align="left" valign="top" style="font-weight: normal;vertical-align:top">                                       
                                            ...
                                            Collected date   &nbsp;&nbsp;&nbsp; : &nbsp; {{ $resultInvoice->order_date }}<br />

                                            Delivary date   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; {{ $resultInvoice->delivery_date }}<br /> 
                            ...
                            <table class="table table-bordered" style="margin-top:-10px;">
                                ...
                                <tbody class="print-page" >
                                    ...
                                    @if($resultComm)
                                    <tr>
                                        <th colspan="2">Discount: @if($resultComm) {{$resultComm->commission}} @endif %</th>
                                        <th colspan="2">Order Discount: @if($resultComm) {{$resultComm->order_commission_value}} @endif</th>
                                        <th ></th> 
                                        <th colspan="3">Delivery Discount: @if($resultComm) {{$resultComm->delivery_commission_value}} @endif</th>
                                        <th ></th>
                                    </tr>
                                    @endif
                                @php
