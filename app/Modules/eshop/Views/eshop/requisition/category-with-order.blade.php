...
@section('content')
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="categories" class="form-control show-tick" onchange="catWiseProducts()" data-live-search="true">
            ...
            <form action="{{ URL('/eshop-requisition-add-to-cart') }}" method="POST">
                {{ csrf_field() }}  
    ...
    <script type="text/javascript">
        function catWiseProducts()
        {
            ...
            $.ajax({
                method: "GET",
                url: '{{url('/eshop-category-wise-products')}}',
