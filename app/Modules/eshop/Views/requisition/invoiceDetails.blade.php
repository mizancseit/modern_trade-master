                                ...
                                <table class="table table-bordered">
                                  ...
                                  <tbody>
                                        ...
                                        $reultPro  = DB::table('tbl_order_details')
                                                    ->select('tbl_order_details.replace_delivered_qty','tbl_order_details.order_det_id','tbl_order_details.cat_id','tbl_order_details.order_id','tbl_order_details.order_qty','tbl_order_details.p_total_price','tbl_order_details.product_id','tbl_order_details.wastage_qty','tbl_order_details.free_qty','tbl_order_details.p_unit_price','tbl_order_details.delivered_qty','eshop_product_category.id AS catid','eshop_product_category.name AS catname','tbl_order.order_id','tbl_order.fo_id','tbl_order.order_type','tbl_order.retailer_id','eshop_product.id','eshop_product.name AS proname')
                                                    ->join('eshop_product_category', 'eshop_product_category.id', '=', 'tbl_order_details.cat_id')
                                                    ->join('tbl_order', 'tbl_order.order_id', '=', 'tbl_order_details.order_id')
                                                    ->join('eshop_product', 'eshop_product.id', '=', 'tbl_order_details.product_id')
                                                ...
                                                @php                                             
                                                    ...
                                                    ->select('fq.type','fq.auto_order_no','fq.catid','fq.product_id','fq.total_free_qty','eshop_product.id','eshop_product.name AS proname')
                                                    ->join('eshop_product', 'eshop_product.id', '=', 'fq.product_id')
                                                    ->where('fq.type','R')      
