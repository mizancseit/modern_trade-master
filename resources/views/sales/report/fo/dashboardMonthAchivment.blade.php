                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" name="fromDate" id="fromdate" class="form-control" value="{{ date('d-m-Y', strtotime($startDate)) }}" placeholder="Select From Date" readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" name="toDate" id="todate" class="form-control" value="{{ date('d-m-Y', strtotime($endDate)) }}" placeholder="Select To Date"  readonly="">
                                </div>
                            </div>
                        </div>
