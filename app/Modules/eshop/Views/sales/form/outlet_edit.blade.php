<form action="{{ URL('/eshop-outlet-edit-process') }}" method="POST">
                        {{ csrf_field() }}    <!-- token -->
                                       ...
                                       <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="col-sm-6 col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="text" class="form-control" placeholder="Mobile No" name="mobile_no" value="{{$resultcus->mobile}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                            </div>
