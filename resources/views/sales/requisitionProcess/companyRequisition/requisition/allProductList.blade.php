                        ...
                        <tbody>
                            @if(sizeof($resultProduct) > 0)
                                ...
                                <tr>
                                    ...
                                    <th>{{ $products->name }}</th>
                                    <th><input type="number" class="form-control" id="qty{{$serial}}" name="qty[]" maxlength="3" pattern="[1-9]" min="1" value="" style="width: 80px;" onkeyup="addReqQty({{$serial}})" onmouseout="totalsFO();">
                                    </th>
