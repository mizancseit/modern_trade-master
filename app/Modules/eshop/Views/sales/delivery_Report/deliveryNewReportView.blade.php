                        ...
                        <table class="table table-bordered" style="margin-top:-10px;">
                            <thead >
                                <tr>
                                    ...
                                    <th></th>
                                    <th class="headerTable" width="7%" valign="middle">Product Code</th>
                            ...
                            <tbody class="print-page" >
                                ...
                                ->select('order_commission_value','delivery_commission_value','commission')
                                ...
                                ->select('eshop_order_details.p_unit_price','eshop_order_details.deliverey_qty','eshop_order_details.order_det_id','eshop_order_details.cat_id','eshop_order_details.order_id','eshop_order_details.order_qty','eshop_order_details.order_total_value','eshop_order_details.product_id','eshop_order_details.p_unit_price','eshop_order.order_id','eshop_order.fo_id','eshop_order.order_status','eshop_order.party_id','eshop_product.id','eshop_product.sap_code','eshop_product.name AS proname')
                                ...
                                <tr>
                                    ...
                                    <th></th>
                                    <td class="rowTableLeft">{{ $itemsPro->sap_code }}</td>
                            ...
                            {{-- <tr>
                                <th colspan="2">Discount: {{$resultComm->commission}} %</th>
                                <th colspan="2">Order Discount: {{$resultComm->order_commission_value}}</th>
                                <th ></th> 
                                <th colspan="3">Delivery Discount: {{$resultComm->delivery_commission_value}}</th>
                                <th ></th>
                            </tr> --}}
