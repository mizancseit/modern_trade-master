            ...
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        BUCKET
                        <small> 
                           <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/return-only-product') }}"> Return </a> / <a href="{!! URL::previous() !!}"> New Order </a> / Bucket
                       </small>
                   </h2>
               </div>
        ...
        <div class="card">                        
            ...
            <div class="body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td>
                                <input type="button" name="edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editReturnOnlyProducts('{{ $itemsPro->return_only_order_det_id }}')" style="width: 70px;">

                                <input type="button" name="delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="returnOnlyItemDelete('{{ $itemsPro->return_only_order_det_id }}')" style="width: 70px; margin-top: 0px;">
                ...
                <div class="row" style="text-align: center;">
                    ...
                    <div class="col-sm-3">
                        <a href="{{ URL('/confirm-only-return/'.$resultInvoice->return_only_order_id.'/'.$resultInvoice->return_only_order_no.'/'.$retailderid.'/'.$routeid.'/'.$pointid.'/'.$distributorID) }}">
