        ...
        <div class="container-fluid">
            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <a href="{{ URL('/admin/except-commission-add') }}">
                            <button type="button" class="btn bg-success btn-block btn-lg waves-effect">ADD CATEGORY</button>
                        </a>
                    </div>                    
                </div>                
            </div>
            ...
            <div class="row clearfix">
                ...
                <th>
                <a href="{{ URL('/admin/except-commission-edit/'.$commissions->id)}}">
