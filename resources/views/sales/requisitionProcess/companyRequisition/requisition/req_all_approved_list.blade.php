					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @if(sizeof($resultReqList) > 0)   
                            ...
                            <tr>
								...
								<th>
                                    <a href="{{ URL('/dist/reqOpenOrderList/'.$ReqRow->req_id) }}" title="Click To Details" target="_blank">
                                      {{ $ReqRow->display_name }}
                                    </a>
                                </th>
							...
							<th style="text-align: center;"> 
                                    <a href="{{ URL('/dist/reqDelivere/'.$ReqRow->req_id) }}" title="Click To Deliver" onClick="return confirm('Are you sure to Delivered?')">
                                        Deliver
                                    </a>   
