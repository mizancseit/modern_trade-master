...
<section class="content">
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        REQUISITION Active List
                        <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Requisition Active 
                        </small>
                    </h2>
                </div>
                </div>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
				...
				<form action="{{ URL('/reqAllActiveList') }}" method="get">
				...
				<form action="{{ URL('/reqInActiveProcess') }}" method="POST">	
				 {{ csrf_field() }}
								...
								<tr>
									<th colspan="10" >
										<div class="col-sm-12" align="center">
											<input  type="submit" name="ORDER_INACTIVE" value="ORDER IN ACTIVE" class="btn bg-green btn-block btn-sm waves-effect" style="width: 140px;">
										</div>	
									</th>
								</tr>	
