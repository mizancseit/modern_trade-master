                   ...
                   <div class="col-md-4">
                                 ...
                                 <div class="col-md-4" id="test1">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <select class="show-tick" data-live-search="true" name="designation" required="" ">
                                        <option value="" id="btype">Please Select Deignation</option>
                                        <option value="SUPER ADMIN" id="">SUPER ADMIN</option>
                                        <option value="SALES COORDINATOR" id="">DITRIBUTOR</option>
                                        <option value="Head Of Sales" id="">Head Of Sales</option>
                                        <option value="GM" id="">GM</option>
                                        <option value="DGM" id="">DGM</option>
                                        <option value="DGM" id="">AGM</option>
                                        <option value="Sr. SM" id="">Sr. SM</option>
                                        <option value="SALES ADMIN" id="">SALES ADMIN</option>
                                        <option value="SALES COORDINATOR" id="">SALES COORDINATOR</option>
                                        <option value="SM" id="">SM</option>
                                        <option value="ASM" id="">ASM</option>
                                        <option value="DSM" id="">DSM</option>
                                        <option value="ADSM" id="">ADSM</option>
                                        <option value="RSM" id="">RSM</option>
                                        <option value="TSM" id="">TSM</option>
                                        <option value="JTSM" id="">JTSM</option>
                                        <option value="SFO" id="">SFO</option>
    ...
    // dd($user); 
                   ...
                   <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                      ...
                                      <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Enter  Cell Phone" name="cell_phone" id="cell_phone" />
                            ...
                            <div class="row clearfix">
                             <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                      ...
                                      <div class="form-line">
                                            <input type="date" class="form-control" placeholder="Enter DOB" name="dob" id="dob"  />
                             ...
                             <div class="text-center">
                                 ...
                                 <input type="hidden" class="form-control" placeholder="" name="id" id="id4"  />
                            <button type="submit"  id="" class="btn btn-default btn-lg waves-effect m-r-20 center-block"><b>Save</b></button>
            ...
            <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
              ...
              @foreach($user_details as $userDetails) 
                    <tr>
                        <?php 
                        $user_name=DB::select(" select * from users where id='$userDetails->user_det_id'");
                        ...
                        <th><input type="button" name="route_edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editUserDetails('{{$userDetails->user_det_id}}')" style="width: 70px;"">
                        </th>
                    </tr>
