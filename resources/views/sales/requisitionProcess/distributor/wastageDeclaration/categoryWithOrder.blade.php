        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2 style="padding-top: 30px;">
                            NEW WASTAGE DECLARATION
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Wastage Declaration
                            </small>
                        </h2>
                    </div>
                    <div class="col-lg-3">                        
                        <div class="info-box-2 bg-red">
                            ...
                            <a href="{{ URL('/dist/was-declaration-bucket/'.$req_id) }}" style="text-decoration: none;" title="Click To Bucket Details">
                                <div class="content">
                                    <div class="text">DECLARATION LIST</div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header"> 
                            <h2>@if(sizeof($resultReqList)>0) {{ $resultReqList[0]->display_name }} @else Category List @endif </h2>                            
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="categories" class="form-control show-tick" onchange="wastageDeclarationProducts()" data-live-search="true">
            ...
            <form action="{{ URL('/dist/was-declaration-add-to-product') }}" method="POST">
                {{ csrf_field() }}    <!-- token -->
