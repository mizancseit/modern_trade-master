                        ...
                        <table width="100%">
                            <thead>
                                ...
                                $retCredLedgerData = DB::select("SELECT crd.* FROM retailer_credit_ledger crd 
                                    ...
                                    AND tord.order_id = '".$orderMainId."' and tord.order_status = 'closed' order by 1 desc limit 1
                                    ");
                                $opening_balance = 0;
                                $netAmount = 0;
                                $newBalance = 0;
                                ...
                                //$newBalance =  ($opening_balance  + $netAmount);   
                                    ...
                                    JOIN tbl_order tord ON tord.order_no = crd.retailer_invoice_no
                                    WHERE tord.retailer_id = '".$resultInvoice->retailer_id."' 
                                    AND tord.order_id = '".$orderMainId."' and tord.order_status != 'closed' order by 1 ASC limit 1
                                    ");
                                    ...
                                    $opening_balance = $retCredLedgerData[0]->retailer_opening_balance;
									 ...
									 $retInvoiceSales = DB::select("SELECT SUM(crd.retailer_invoice_sales) AS retailer_invoice_total_sales
									 FROM retailer_credit_ledger crd 
                                    JOIN tbl_order tord ON tord.order_no = crd.retailer_invoice_no
                                    WHERE tord.retailer_id = '".$resultInvoice->retailer_id."' 
                                    AND tord.order_id = '".$orderMainId."'
                                    ");
									
                                    $netAmount = $retInvoiceSales[0]->retailer_invoice_total_sales;
