            ...
            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                ...
                @if(sizeof($resultOrderList) > 0)   
                    ...
                    <tr>
                        <th>{{ $serial }}</th>
                        <th>
                            <a href="{{ URL('/eshop-make-invoice-view/'.$orders->order_id.'/'.$orders->fo_id) }}" title="Confirm Delivery" target="_blank">
                                {{ $orders->order_no }}
                            </a>
                        </th>
                        ...
                        <th style="text-align: right;"><a href="{{ URL('/eshop-make-invoice-stock-out2/'.$orders->order_id.'/'.$orders->fo_id) }}" title="Confirm Delivery" target="_blank" class="btn bg-pink btn-block btn-lg waves-effect">Make Invoice</a></th>
