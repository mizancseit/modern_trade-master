...
@section('content')
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2 style="padding-top: 30px;">
                            EDIT ORDER
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href="{{ URL('/order-manage-exception') }}"> Order Manage </a> / Edit Order
                            </small>
                        </h2>
                    </div>
                    <div class="col-lg-3">
                            ...
                            <div class="info-box-2 bg-red">
                                ...
                                <a href="{{ URL('/bucket-edit-exception/'.Request::segment(2).'/'.$pointID.'/'.$routeid.'/'.$retailderid.'/'.Request::segment(5).'/'.Request::segment(6)) }}" title="Click To Bucket Details">
                                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <select id="categories" class="form-control show-tick" onchange="allOrderManageProductsExc()" data-live-search="true">
            ...
            <form action="{{ URL('/add-to-edit-cart-exception') }}" method="POST">
                {{ csrf_field() }}    <!-- token -->
                ...
                <input type="hidden" id="partial_id" name="partial_id" value="{{ Request::segment(5) }}">
