        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">                        
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-sm-3">
                        <a href="{{ URL('/eshop-approved-delivery/'.$resultInvoice->order_id.'/'.$resultInvoice->customer_id.'/'.'yes') }}">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect">Invoice confirm</button>
                        </a>
                    </div>
                    <div class="col-sm-3">
