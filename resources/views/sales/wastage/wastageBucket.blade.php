            ...
            <div class="body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $totalWastageValue += $itemsPro->p_total_price;
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">@if($itemsPro->p_total_price=='') {{ 0 }} @else {{ $itemsPro->p_total_price }} @endif</td>
                            <td>
                                ...
                                <input type="button" name="delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="wastageItemDelete('{{ $itemsPro->order_det_id }}','{{ $itemsPro->order_id }}')" style="width: 70px; margin-top: 0px;">
                ...
                <div class="row" style="text-align: center;">
                    ...
                    <div class="col-sm-3">
                        <a href="{{ URL('/confirm-wastage/'.$resultInvoice->order_id.'/'.$resultInvoice->order_no.'/'.$retailderid.'/'.$routeid.'/'.$pointid.'/'.$distributorID) }}">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect">Confirm Wastage Request</button>
                        </a>
                    </div>
                    <div class="col-sm-2">
                        <a href="{{ URL('/delete-wastage/'.$resultInvoice->order_id.'/'.$retailderid.'/'.$routeid) }}">
