        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-9">
                        <h2>
                            Requisition Received Deatils
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href=""> Req Received List </a>
                            </small>
                        </h2>
                    </div>
                            ...
                            <table class="table table-bordered">
                                    <thead>
										<tr>
                                            ...
                                            <th colspan="3">Status: &nbsp;  Received </th>                  
                                        </tr>
                                        <tr>
                                            <th>SL</th>
                                            <th>Product Group</th>
                                    ...
                                    <tbody>
                                        ...
                                        $receivedQty += $items->received_qnty;
                                        $receivedValue += $items->received_value;                    
                                        @endphp                                     
										...
										<tr>
                                            ...
                                            <tr>
												...
												<th style="text-align: right;">{{ $items->received_qnty }}</th>
												<th style="text-align: right;">{{ $items->received_value }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: right;">{{ $receivedQty }}</th>
                                            <th style="text-align: right;">{{ $receivedValue }}</th>
                                        </tr>
