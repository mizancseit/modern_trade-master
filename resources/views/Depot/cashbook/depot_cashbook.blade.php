    ...
    <div class="body">
          ...
          <br>
             <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <form action="{{ URL('/depot_cashbook_process') }}" method="post">
                {{ csrf_field() }}    <!-- token -->
            ...
            <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
			 ...
			 @if(sizeof($depotCashbook) > 0)   
                    ...
                    <tr>
                        ...
                        <th><input type="button" name="cashbook_edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editDepotCashbook('{{ $RowDepotCashbook->cash_book_id }}')" style="width: 70px;"">
                        <input type="button" name="cashbook_delete" id="delete" value="Delete" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="deleteDepotCashbook('{{ $RowDepotCashbook->cash_book_id}}')" style="width: 70px; margin-top: 0px;"></th>
                    </tr>
