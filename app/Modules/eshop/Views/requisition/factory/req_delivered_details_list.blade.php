        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-9">
                        <h2>
                            Requisition Delivered Deatils
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / <a href=""> Req Delivered List </a>
                            </small>
                        </h2>
                    </div>
                            ...
                            <table class="table table-bordered">
                                    <thead>
										<tr>
                                            ...
                                            <th colspan="3">Status: &nbsp; {{ strtoupper($resultReqPro[0]->req_status) }}</th>                  
                                        </tr>
                                        <tr>
                                            <th>SL</th>
                                            <th>Product Group</th>
                                    ...
                                    <tbody>
                                        ...
                                        $deleveredQty += $items->delevered_qnty;
                                        $deleveredValue += $items->delevered_value;                    
                                        @endphp                                                              
                                       ...
                                       <tr>
                                            ...
                                            <th style="text-align: right;">{{ $deleveredQty }}</th>
                                            <th style="text-align: right;">{{ $deleveredValue }}</th>
                                        </tr>
