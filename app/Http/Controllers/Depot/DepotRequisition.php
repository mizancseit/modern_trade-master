...
class DepotRequisition extends Controller
{
	/**
	*
	...
	**/
    ...
    public function req_manage()
    {
        ...
        return view('Depot.requisition.req_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultReqList'));
    }
	...
	public function req_add()
    {
        ...
        return view('Depot.requisition.req_add', compact('selectedMenu','selectedSubMenu','pageTitle','reqAddList','LastReqId'));
    }
	...
	public function req_list_product($req_id)
	{
		...
		return view('Depot.requisition.categoryWithOrder', compact('selectedMenu','selectedSubMenu','pageTitle',
	...
	public function req_category_products(Request $request)
    {
        ...
        return view('Depot.requisition.allProductList', compact('resultProduct','categoryID'));
    }
	...
	public function req_bucket($reqid)
    {
        ...
        return view('Depot.requisition.bucket', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
    }
	...
	public function req_send_list()
	{
        ...
        return view('Depot/requisition/req_send_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultReqList'));			
	...
	public function req_pending_list(Request $req)
	{
        ...
        return view('Depot/requisition/req_pending_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultReqList','divList',
	...
	public function req_analysis_list(Request $req)
	{
        ...
        return view('Depot.requisition.req_analysis_list', compact('selectedMenu','approved','pageTitle','resultReqList','divList','custList'));			
	...
	public function req_analysis_list_new(Request $req)
	{
		...
		$resultAnalysisList = DB::select("SELECT drd.req_id, drd.req_det_id, pcat.id as cat_id, pcat.name as pro_cat_name, 
								prd.id as prod_id, prd.name as prod_name, prd.sap_code, p.point_division,
								SUM(prd.stock_qty) as ssg_stk, SUM(drd.req_qnty) as req_qnty, 
								SUM(drd.approved_qnty) as update_qnty, SUM(drd.req_qnty - prd.stock_qty) as adjust_qty
								FROM depot_requisition dr JOIN depot_req_details drd ON dr.req_id = drd.req_id
								JOIN users u ON u.id = dr.depot_in_charge
								JOIN tbl_product prd ON prd.id = drd.product_id 
								JOIN tbl_product_category pcat ON pcat.id = drd.cat_id 
								JOIN tbl_point p ON p.point_id = dr.point_id
								JOIN tbl_division d ON d.div_id = p.point_division
        ...
        return view('Depot.requisition.analysis.req_analysis_list', 
	...
	public function req_order_analysis($reqid)
	{
        ...
        return view('Depot.requisition.req_order_analysis', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	}
	...
	public function req_order_analysis_new($prodid)
	{
        ...
        return view('Depot/requisition/analysis/req_order_analysis', compact('selectedMenu','pageTitle','resultReqPro'));
	}
	...
	*/
	...
	public function req_all_approved_list()
	{
        ...
        return view('Depot.requisition.req_all_approved_list', compact('selectedMenu','approved','pageTitle','resultReqList'));			
	...
	public function req_open_order_list($reqid)
    {
        ...
        return view('Depot.requisition.req_delivery_download_list', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	...
	public function req_bill_details_list($reqid)
    {
        ...
        return view('Depot.requisition.req_bill_details_list', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	...
	public function req_billed_process($req_id)
	{
		if($req_id)
		{
			...
			$DepotReqDetUpd = DB::update('UPDATE depot_req_details SET billed_qnty = approved_qnty, billed_value = approved_value 
										WHERE req_id = ?', [$req_id]);				
										
						

			//split factory wise requisition
			$this->req_factory_wise_split($req_id);		
			
			//PartyLedger for delivery		
			$this->party_lifting($req_id);									
										
		}
		
		return Redirect::to('/reqAllBilledList/')->with('success', 'Successfully Billed.');
	}
	...
	public function req_billed_list()
	{
        ...
        return view('Depot.requisition.req_billed_list', compact('selectedMenu','approved','pageTitle','resultBilledList'));			
	...
	public function req_all_billed_list()
	{
        ...
        return view('Depot.requisition.req_all_billed_list', compact('selectedMenu','approved','pageTitle','resultReqList'));			
	...
	public function req_ready_for_delivery()
	{
        ...
        return view('Depot.requisition.factory.req_ready_delivery_list', compact('selectedMenu','approved','pageTitle','resultReqList'));			
	...
	public function req_delivery_item_list($reqid)
    {
        ...
        return view('Depot.requisition.factory.req_delivery_item_list', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	...
	public function req_all_delivered_list()
	{
        ...
        return view('Depot.requisition.factory.req_all_delivered_list', compact('selectedMenu','approved','pageTitle','resultReqList'));			
	...
	*/
	...
	public function req_delivered_list()
	{
        ...
        return view('Depot.requisition.req_delivered_list', compact('selectedMenu','approved','pageTitle','resultReqList'));			
	...
	public function req_all_received_list()
	{
        ...
        return view('Depot.requisition.factory.req_all_received_list', compact('selectedMenu','approved','pageTitle','resultReqList'));			
	...
	public function req_delivered_details_list($reqid)
    {
        ...
        return view('Depot.requisition.factory.req_delivered_details_list', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	...
	public function req_details_list($reqid)
    {
        ...
        return view('Depot.requisition.req_details_list', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	...
	public function req_delivery_challan($reqid)
    {
        ...
        return view('Depot.requisition.req_delivery_challan', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
	...
	public function req_delivery_received_list($reqid)
    {
        ...
        return view('Depot.requisition.req_delivery_receive_list', compact('selectedMenu','pageTitle','resultReqPro','reqid'));
...
//$items = Item::all();
	...
	public function depot_items_edit(Request $request)
    {
        ...
        return view('Depot.requisition.editReqItems', compact('depotResult'));
    }
	...
	public function req_active_list(Request $req)
	{
        ...
        return view('Depot/requisition/active_inactive/req_active_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultReqList','divList'));			
	...
	public function req_inactive_list(Request $req)
	{
        ...
        return view('Depot/requisition/active_inactive/req_in_active_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultReqList','divList'));			
	...
	public function cust_active_list(Request $req)
	{
        ...
        return view('Depot/requisition/active_inactive/cust_active_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultCustList','divList'));			
	...
	public function cust_inactive_list(Request $req)
	{
        ...
        return view('Depot/requisition/active_inactive/cust_in_active_list', compact('selectedMenu','selectedSubMenu','pageTitle','resultCustList','divList'));			
...
','Ship To Party','Ref PO No','Ref PO Date','req del date','Order Note','Debit/Credit Note','Order Reason','Currency','Material Code','Qty','Plant Code','Storage Loc','Batch','Item Category','ZASV','ZEXP','ZFRH','ZTHP','ZSCR','ZRMS','ZAST');
	...
	public function export_sale_order(Request $Request) 
	{
		...
		->join('tbl_product_category', 'tbl_product_category.id', '=', 'depot_req_details.cat_id')
		->join('tbl_product', 'tbl_product.id', '=', 'depot_req_details.product_id')
		->where('depot_requisition.req_status', 'billed')
		->where('depot_requisition.is_active', 'YES')
		->where('depot_requisition.is_download', 'NO')
		->where('depot_requisition.parent_req_id', 0)
		->orderBy('depot_requisition.req_id','DESC')                    
		->get()->toArray();
...
','Ship To Party','Ref PO No','Ref PO Date','req del date','Order Note','Debit/Credit Note','Order Reason','Currency','Material Code','Qty','Plant Code','Storage Loc','Batch','Item Category','ZASV','ZEXP','ZFRH','ZTHP','ZSCR','ZRMS','ZAST');
		...
		foreach ($items as $value) 
		{
			...
			if($value->AppQty>0){
				...
				$ReqDownUpd = DB::table('depot_requisition')->where('req_no',$value->req_no)->update(
						[
							'is_download'  => 'YES',
