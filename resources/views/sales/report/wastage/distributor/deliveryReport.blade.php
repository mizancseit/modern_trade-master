            ...
            <div class="card">
                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="distributorWastageDelivery()">Search</button>
                        </div>
                    </div>                                  
                </div>
            </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultOrderList) > 0)   
                                    ...
                                    <tr>
										...
										<!-- 
											<a href="{{ URL('/report/wastage/distributor/invoice-details-delivery/'.$orders->order_id) }}" title="Invoice Details" target="_blank">
												{{ $orders->order_no }}
											</a>
										-->	
                                           
										<a href="{{ URL('/report/wastage/fo/invoice-details-delivery/'.$orders->order_id) }}" title="Invoice Details" target="_blank">
											{{ $orders->order_no }}
										</a>
