                    ...
                    <div class="body">
                            ...
                            <table class="table table-bordered" style="margin-top:-10px;">
                                ...
                                <tbody class="print-page" >
                                    ...
                                    <tr>
                                        <th></th>
                                        <th colspan="6">{{ $items->catname }} <span class="pull-right">Discount: {{$resultComm->commission}}, Value: {{$resultComm->order_commission_value}}</span></th>
                                    </tr>
                                    @php 
