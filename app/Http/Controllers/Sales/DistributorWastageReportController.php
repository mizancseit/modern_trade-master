...
class DistributorWastageReportController extends Controller
{
	/**
	*
    ...
    */    
    ...
    public function wastage_report_fo_order()
    {
        ...
        $resultRoute    = DB::table('tbl_wastage')
                        ->select('tbl_wastage.global_company_id','tbl_wastage.order_type','tbl_wastage.route_id','tbl_wastage.distributor_id','tbl_route.rname','tbl_route.route_id')
        ...
        return view('sales.report.wastage.distributor.orderReport', compact('selectedMenu','selectedSubMenu','pageTitle','resultRoute','resultOrderList'));
    }
    ...
    public function wastage_report_fo_order_list(Request $request)
    {
        ...
        return view('sales.report.wastage.distributor.orderReportList', compact('resultOrderList'));
    }
    ...
    public function wastage_order_details($orderMainId)
    {
        ...
        $resultCartPro  = DB::table('tbl_wastage_details')
                        ->select('tbl_wastage_details.cat_id','tbl_wastage_details.order_id','tbl_product_category.id AS catid','tbl_product_category.name AS catname','tbl_wastage.order_id','tbl_wastage.fo_id','tbl_wastage.distributor_id','tbl_wastage.order_type','tbl_wastage.order_no','tbl_wastage.retailer_id','tbl_wastage.global_company_id')
        ...
        $resultDistributorInfo = DB::table('tbl_wastage')->select('tbl_user_details.first_name','tbl_user_details.cell_phone','tbl_wastage.global_company_id','tbl_wastage.order_id','tbl_wastage.order_type','tbl_wastage.fo_id','tbl_wastage.distributor_id','tbl_point.point_id','tbl_point.point_name','tbl_route.route_id','tbl_route.rname')
                        ->join('tbl_user_details', 'tbl_user_details.user_id', '=', 'tbl_wastage.distributor_id')
    ...
    */    
    ...
    public function wastage_report_fo_delivery()
    {
        ...
        $pageTitle      = 'Wastage Delivery';            // Page Slug Title
         ...
         $resultRoute    = DB::table('tbl_wastage')
                        ->select('tbl_wastage.global_company_id','tbl_wastage.order_type','tbl_wastage.route_id','tbl_wastage.distributor_id','tbl_wastage.fo_id','tbl_route.rname','tbl_route.route_id')
        ...
        $resultOrderList = DB::table('tbl_wastage')
                        ...
                        ->where('tbl_wastage.global_company_id', Auth::user()->global_company_id)
                        ->where('tbl_wastage.distributor_id', Auth::user()->id)
                        ->whereBetween(DB::raw("(DATE_FORMAT(tbl_wastage.update_date,'%Y-%m-%d'))"), array($todate, $todate))
                        ->orderBy('tbl_wastage.order_id','DESC')                    
                        ->get();

        return view('sales.report.wastage.distributor.deliveryReport', compact('selectedMenu','selectedSubMenu','pageTitle','resultRoute','resultOrderList'));
    }
    ...
    public function wastage_report_fo_delivery_list(Request $request)
    {
        ...
        return view('sales.report.wastage.distributor.deliveryReportList', compact('resultOrderList'));
    }
    ...
    public function wastage_report_fo_delivery_details($orderMainId)
    {
        ...
        $resultCartPro  = DB::table('tbl_wastage_details')
                        ->select('tbl_wastage_details.cat_id','tbl_wastage_details.order_id','tbl_product_category.id AS catid','tbl_product_category.name AS catname','tbl_wastage.order_id','tbl_wastage.distributor_id','tbl_wastage.fo_id','tbl_wastage.order_type','tbl_wastage.order_no','tbl_wastage.retailer_id','tbl_wastage.global_company_id')
                        ->join('tbl_product_category', 'tbl_product_category.id', '=', 'tbl_wastage_details.cat_id')
                        ->join('tbl_wastage', 'tbl_wastage.order_id', '=', 'tbl_wastage_details.order_id')
                        ->where('tbl_wastage.global_company_id', Auth::user()->global_company_id)                       
                        ->where('tbl_wastage.distributor_id',Auth::user()->id)                        
        ...
        $resultDistributorInfo = DB::table('tbl_wastage')->select('tbl_user_details.first_name','tbl_user_details.cell_phone','tbl_wastage.global_company_id','tbl_wastage.order_id','tbl_wastage.order_type','tbl_wastage.distributor_id','tbl_wastage.fo_id','tbl_point.point_id','tbl_point.point_name','tbl_route.route_id','tbl_route.rname')
                        ->join('tbl_user_details', 'tbl_user_details.user_id', '=', 'tbl_wastage.distributor_id')
                        ->join('tbl_point', 'tbl_point.point_id', '=', 'tbl_wastage.point_id')
                        ->join('tbl_route', 'tbl_route.route_id', '=', 'tbl_wastage.route_id')
                        ->where('tbl_wastage.global_company_id', Auth::user()->global_company_id)                        
        ...
        return view('sales.report.wastage.distributor.invoiceDetailsDelivery', compact('selectedMenu','selectedSubMenu','pageTitle','resultCartPro','resultInvoice','orderMainId','foMainId','resultFoInfo','resultDistributorInfo'));
    }
