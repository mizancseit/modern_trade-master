...
@endif 
<form action="{{ URL('/eshop-partial-delivery-receive') }}" method="POST">
    {{ csrf_field() }}    <!-- token -->
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">                        
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            @endphp
                            @if(($itemsPro->deliverey_qty - $itemsPro->received) > 0 )
                            <tr>
                                <td>{{ $serial }}</td>
                                <td></td>
                                ...
                                <input type="text" name="qty[{{ $itemsPro->product_id }}]" value="{{$itemsPro->deliverey_qty - $itemsPro->received}}"></td> 
                ...
                <input type="hidden" name="foMainId" id="foMainId" value="">
