                        ...
                        <tbody>
                            @if(sizeof($resultProduct) > 0)
                                ...
                                <tr>
                                    ...
                                    <th><input type="number" class="form-control" id="qty{{$serial}}" name="qty[]" maxlength="3" pattern="[1-9]" min="1" value="{{$pOrderQty->order_qty}}" style="width: 80px;" onkeyup="addQty({{$serial}})" onmouseout="totalsFO();" readonly="">
                                    </th>
                                    @else
                                    ...
                                    <th><input type="number" class="form-control" id="wastageQty{{$serial}}" name="wastageQty[]" maxlength="3" style="width: 80px;" onkeyup="totalsWastagesFO();addWastage({{$serial}})"></th>                                            
                                </tr>
                                @php
                                $serial ++;
                                @endphp
