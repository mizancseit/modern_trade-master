                            ...
                            <div class="body">
                                <table class="table table-bordered">
                                        ...
                                        $reultPro  = DB::table('tbl_order_details')
													...
													/*
													DB::raw('SUM(tbl_order_details.order_qty) AS order_qty'), DB::raw('SUM(tbl_order_details.p_total_price) AS p_total_price'),
													'tbl_order_details.product_id',
													DB::raw('SUM(tbl_order_details.wastage_qty) AS wastage_qty'), DB::raw('SUM(tbl_order_details.p_unit_price) AS p_unit_price'), 
													'tbl_product_category.id AS catid',
													*/
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="5">{{ round($commissionAmount - $valueSum).' ('.$svwRows->commission.'%'.') ' }} 
                                                    <a href="{{ URL('/order-process-valuewise/'.$retailderid.'/'.$routeid.'/'.$svwRows->order_id.'/'.$totalFreeValueWiseCommission.'/'.$items->catid.'/'.$svwRows->offer_id.'/'.'1'.'/'.Request::segment(5)) }}">
