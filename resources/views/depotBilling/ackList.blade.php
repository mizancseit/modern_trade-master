    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card" style="overflow-y: auto;">
				...
				<form action="{{ URL('/depotAckList') }}" method="get">
                 ...
                 <div class="table-responsive">  
					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
						...
						<div class="header">    
							<h5>
								...
								<div class="col-sm-12" align="right">
									<form action="{{url('download_depotAckList')}}" enctype="multipart/form-data">
					   ...
					   <th>{{$payment->branch_name}}</th> 
                        ...
                        <th><a href="{{ URL('/depo-payment-undo/'.$payment->transaction_id) }}" class="btn bg-pink btn-block btn-lg waves-effect"> Undo</a>
						</th> 
						</tr>
