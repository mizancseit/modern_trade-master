                ...
                <div class="header">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-left">
                         <input type="text" name="po_no" id="po_no" class="form-control" value="{{ $resultInvoice->po_no}}"> 
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ->select('eshop_order_details.order_det_id','eshop_order_details.product_id','eshop_order_details.cat_id','eshop_order_details.order_id','eshop_product_category.id AS catid',
                            'eshop_product_category.name AS catname','eshop_order.order_id','eshop_order.fo_id','eshop_order.order_status',
                            'eshop_order.order_no','eshop_order.party_id','eshop_order_details.order_qty','eshop_order_details.p_unit_price','eshop_order_details.order_total_value','eshop_order_details.item_discount','eshop_order_details.order_date','eshop_product.name as proname','eshop_product.sap_code')
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">@if($itemsPro->item_discount=='') {{ 0 }} @else {{ $itemsPro->item_discount }} @endif</td>
                                <td>
                                    ...
                                    <a href="{{ URL('/eshop-items-delete/'.$itemsPro->order_id.'/'.$itemsPro->order_det_id.'/'.$customer_id.'/'.$partyid.'/'.$items->catid) }}">
                            ...
                            <tr>
                                ...
                                <th></th>
                                <th style="text-align: right;"> {{$item_discount }}</th>
                                <th>&nbsp;</th>
                            </tr>
                            <tr>
