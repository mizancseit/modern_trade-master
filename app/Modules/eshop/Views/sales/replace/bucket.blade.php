            ...
            <div class="row">
                <div class="col-lg-9">
                    <h2>
                        BUCKET
                        <small> 
                           <a href="{{ URL('/dashboard') }}">Dashboard</a>/<a href="{{ URL('/eshop-replace') }}"> Replace </a>/<a href="{!! URL::previous() !!}">Order</a>/Bucket
                       </small>
                   </h2>
               </div>

               <div class="col-lg-3">
                <a href="{{ URL('/eshop-replace-process/'.$partyid.'/'.$customer_id) }}">
...
@endif
<form action="{{ URL('/eshop-confirm-replace') }}" method="post">
      {{ csrf_field() }}  
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ->select('eshop_replace_details.replace_det_id','eshop_replace_details.product_id','eshop_replace_details.cat_id','eshop_replace_details.replace_id','eshop_product_category.id AS catid',
                            'eshop_product_category.name AS catname','eshop_replace.replace_id','eshop_replace.fo_id','eshop_replace.order_status',
                            'eshop_replace.replace_no','eshop_replace.party_id','eshop_replace_details.order_qty','eshop_replace_details.p_unit_price','eshop_replace_details.order_total_value','eshop_replace_details.replace_date','eshop_product.name as proname','eshop_product.sap_code')
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ URL('/eshop-replace-items-delete/'.$itemsPro->replace_id.'/'.$itemsPro->replace_det_id)}}">
                    ...
                    <div class="row" style="text-align: center;">
                        ...
                        <div class="col-sm-2">
                            <a href="{{ URL('/eshop-delete-replace/'.$resultInvoice->replace_id.'/'.$partyid.'/'.$customer_id) }}">
