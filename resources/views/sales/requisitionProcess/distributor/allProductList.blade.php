            ...
            <div class="header">                
                <div class="row">
                    ...
                    <div class="col-sm-2" style="text-align: right;">
                        <button type="submit" class="btn bg-pink btn-block btn-lg waves-effect">ADD STOCK</button>
                    </div>
                        ...
                        <tbody>
                            @if(sizeof($resultProduct) > 0)
                                ...
                                <tr>
                                    ...
                                    <th>{{ $products->name }}</th>
                                    <th><input type="number" class="form-control" id="qty{{$serial}}" name="qty[]" maxlength="3" value="" style="width: 80px;" onkeyup="addStockQty({{$serial}})">
                                    </th>
