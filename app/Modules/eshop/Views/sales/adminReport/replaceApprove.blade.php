            ...
            <div class="card">
                ...
                <div class="body">                    
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="replaceDeliveryApproved()">Search</button>
                        </div>
                    </div> 
                     <div class="row">  
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @if(sizeof($resultOrderList) > 0)   
                                    ...
                                    <tr>
                                        <th>{{ $serial }}</th>
                                        <th>
                                            <a href="{{ URL('/eshop-replace-delivery-approved-view/'.$orders->replace_id.'/'.$orders->fo_id) }}" title="Confirm Delivery" target="_blank">
                                                {{ $orders->replace_no }}
                                            </a>
                                        </th>
