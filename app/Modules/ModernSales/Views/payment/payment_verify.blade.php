                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
                        ...
                        <tbody>
                           ...
                           <td> 
                            ...
                            <input type="checkbox" id="tran_id{{$RowoutletPayment->transaction_id}}" name="tran_id[{{$key}}]" value="{{$RowoutletPayment->transaction_id}}" class="verify-checkbox filled-in" onclick="" />
...
<script type="text/javascript">
    ...
    {  
       ...
       function toggleCheckAll() {
            ...
            console.log("Check All Link Clicked");
            
            // Check if all checkboxes are checked or unchecked, then toggle
