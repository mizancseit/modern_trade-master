					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @if(sizeof($resultReqList) > 0)   
                            ...
                            <tr>
                                <th>{{ $serial }}</th>
                                <th>
                                    <a href="{{ URL('/dist/req-bucket/'.$ReqRow->req_id) }}" title="Click To Edit Invoice" target="_blank">
                                        {{ $ReqRow->display_name }}
                                    </a>
                                </th>
								...
								<div class="icon">
									 ...
									 <a href="{{ URL('/dist/req-send/'.$ReqRow->req_id) }}" title="Click To Send" onClick="return confirm('Are you sure to send?')">
