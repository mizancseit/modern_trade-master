                                     ...
                                     <div class="col-sm-12 col-md-12">
                                       <div class="row clearfix">
                                         <div class="col-sm-12 col-md-6">
                                            <label for="qty">OFFER ID :*</label>
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" placeholder="Offer id" name="offerid" required="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" name="product_edit" id="edit" value="Edit" class="btn bg-red btn-block btn-sm waves-effect" data-toggle="modal" onclick="editSpecialProduct('{{ $regularProduct->id }}','{{ $regularProduct->offerProId }}')" style="width: 70px;">
