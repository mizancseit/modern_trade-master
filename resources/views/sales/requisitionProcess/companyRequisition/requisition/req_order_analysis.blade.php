        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">                        
                ...
                <div class="body">
                    ...
                    <form action="{{ URL('/dist/reqApproved') }}" method="POST">	
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right;">
                                        <input type="text" class="form-control" class="form-control" maxlength="4" 
                                        style="width: 80px;" id="value{{$serial}}" name="approved_wastage_<?=$items->req_det_id?>" value="@if($items->wastage_qty!=Null){{ $items->wastage_qty }}@else 0 @endif" />
                                    </th>
