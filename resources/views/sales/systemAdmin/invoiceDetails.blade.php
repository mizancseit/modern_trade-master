                ...
                <div class="row">
                    <div class="col-lg-9">
                        <h2>
                            Invoice
                            <small> 
                             <a href="{{ URL('/dashboard') }}"> Dashboard </a> / Invoice
                            </small>
                        </h2>
                    </div>
                    ...
                    <div class="card" style="font-weight:">
                         <div class="body" id="printMe" >
                            <table width="100%">
                                    <thead>
                                        <tr>
                                            <th width="40%" height="49" align="left" valign="top">
                                            ...
                                            <th width="30%" id="watermark">
                                                 @if($resultInvoice->order_type!='Delivered') <p id="bg-text"> NOT CONFIRM </p> @endif
                                            </th>
                                  ...
                                  <tbody>
                                        ...
                                        <tfoot>
                                            ...
                                            @if(sizeof($specialValueWise)>0)               
                                                ...
                                                <th @if(Auth::user()->user_type_id==19) colspan="4" @else colspan="4" @endif> 
                                                    @php
                                                ...
                                                <th @if(Auth::user()->user_type_id==19) colspan="6" @else colspan="2" @endif style="text-align: left; padding-left: 40px;">{{ $svwRows->commission.'%' }} 
                                            ...
                                            @if(sizeof($commissionWiseItem)>0)
                                                ...
                                                <tr style="background:#EEEEEE;">
                                                    <th @if(Auth::user()->user_type_id==19) colspan="10" @else colspan="6" @endif> Exclusive Value Wise Free Items </th>
                                                </tr>
                                                @php
                                                $cPrice =0;
                                                $cqty =0;
                                            ...
                                            <tr style="background-color: #EEEEEE">
                                                ...
                                                <th @if(Auth::user()->user_type_id==19) colspan="3" @else colspan="3" @endif> @if($resultBundleOffersGift->productType==2) {{ $resultBundleOffersGift->giftName }} @else {{ $resultBundleOffersGift->name }} @endif </th>
