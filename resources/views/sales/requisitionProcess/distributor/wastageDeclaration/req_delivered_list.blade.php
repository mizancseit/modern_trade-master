					...
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @if(sizeof($resultReqList) > 0)   
                            ...
                            <tr>
								...
								<th>
                                    <a href="{{ URL('/dist/was-req-delivered-details-list/'.$ReqRow->req_id) }}" title="Click To Details" target="_blank">
                                     {{ $ReqRow->req_no }}
                                    </a>
                                </th>
                             ...
                             @endphp
                               ...
                               <th>
                                ...
                                <a href="{{ URL('/dist/was-req-delivery-challan/'.$ReqRow->req_id) }}" target="_blank" title="Click To View Delivery Challan">
                                ...
                                <a href="{{ URL('/dist/was-req-delivery-received-list/'.$ReqRow->req_id) }}" target="_blank" title="Click To Received">
                                        Received
                                    </a>  ||
