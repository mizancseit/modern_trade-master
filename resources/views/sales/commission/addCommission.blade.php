    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <form action="{{ URL('/admin/commission-submit') }}" id="form" method="POST">
                        {{ csrf_field() }}    <!-- token -->
                        ...
                        <div class="body"> 
                            ...
                            <div class="input-group">
                                <div class="col-md-6 align-left" style="padding-left:0px;">
                                    ...
                                    <div class="form-line">
                                        <input type="number" id="minSlab" name="minSlab" class="form-control" placeholder="Enter Min Limit" value="" required="" maxlength="10">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 align-left" style="padding-left:0px;">
                                    ...
                                    <div class="form-line">
                                        <input type="number" id="maxSlab" name="maxSlab" class="form-control" placeholder="Enter Max Limit" value="" required="" maxlength="10">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                <div class="col-md-6 align-left" style="padding-left:0px;">
                                    ...
                                    <div class="form-line">
                                        <input type="number" id="rat" name="rat" class="form-control" placeholder="Enter Rate Number" value="" required="" maxlength="10">
                                    </div>
                                </div>
                            ...
                            <div class="row" style="text-align: center;">
                                <div class="col-sm-3">                                        
                                    <button type="submit" id="in" class="btn bg-pink btn-block btn-lg waves-effect">ADD COMMISSION</button>
                                </div>
                            </div>
                        </div>
                    </form>
