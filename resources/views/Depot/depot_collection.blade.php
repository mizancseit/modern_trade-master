 ...
 <section class="content">
    ...
    <div class="body">
                            ...
                            <div class="row clearfix">
								...
								<div class="col-sm-12">
								   ...
								   <label for="division">DEPOT:*</label>
									...
									<label for="division">Route:*</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line" id="div_ratailer">
		...
		<div class="table-responsive">
				...
				<form action="{{ URL('/DepotCollection') }}" method="get">
					...
					<div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" name="fromCollectionDate" id="fromdate1" class="form-control" value="" placeholder="Select From Date" readonly="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" name="toCollectionDate" id="todate1" class="form-control" value="" placeholder="Select To Date"  readonly="">
                                </div>
                            </div>
                        </div>
		    ...
		    <table class="table table-bordered table-striped table-hover dataTable js-basic-example dataTable">
			 ...
			 @if(sizeof($depotCollection) > 0)   
                    ...
                    @php                    
                    $totalCollection += $RowDepotCollection->collection_amount;
                    @endphp
					<tr>
                ...
                <tfoot>
                   <tr>
                        <th colspan="4" style="text-align: right;">Total Collection :</th>
                        <th colspan="4"> {{ $totalCollection }}</th>
                    </tr>
                </tfoot>
                @else                
                    <tr>
