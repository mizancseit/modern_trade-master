        ...
        <div class="card">
            ...
            <div class="body">
               ...
               <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn bg-pink btn-block btn-lg waves-effect" onclick="accountsPaymentReportList()">Search</button>
                </div>
                <div class="col-sm-2">
                    <a href="{{url('eshop-accounts_payments_rece_report_download/')}}" class="btn bg-pink btn-block btn-lg waves-effect" id="download_url">Download Report</a>
                </div>
            </div> 
