    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <form action="{{ URL('/admin/except-commission-update') }}" id="form" method="POST">
                        {{ csrf_field() }}    <!-- token -->
                        ...
                        <div class="body"> 
                            ...
                            <div class="input-group">
                                ...
                                <select id="categoryId" name="categoryId" class="form-control show-tick" required="" data-live-search="true">
                                    ...
                                    <option value="{{ $categorys->id }}" @if($edit->categoryId==$categorys->id) selected="" @endif> {{ $categorys->name }} </option>
                                    @endforeach
                                </select>
                            </div>                            
                            ...
                            <div class="row" style="text-align: center;">
                                <div class="col-sm-3">                                        
                                    <button type="submit" id="in" class="btn bg-pink btn-block btn-lg waves-effect">UPDATE CATEGORY</button>
                                </div>
                            </div>
                        </div>
                    </form>
